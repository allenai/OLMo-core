# Tech-report operating point: Small-64E, 24 Mi GBS, random routing (headline row).
# Identical to OLMoE3-dev-s001.py except: RANDOM_ASSIGN = False -> RANDOM_ASSIGN = True.
import logging
import math
import os
import socket
