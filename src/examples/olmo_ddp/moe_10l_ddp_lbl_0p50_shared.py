# Two-node launch (8 GPUs/node, using hostfile2):
# bash /workspace/beaker-toolbox/run_script_remotely.sh /workspace/hostfile2 /workspace/beaker-toolbox/node_cmd-tech-report-lbl.sh "moe_10l_ddp_lbl_0p50_shared_1x2560 token-gerrymandering-10l-lbl-0p50-shared-1x2560"

"""Ten-layer LBL-weight run with one 2560-wide shared expert."""
...
# intentionally hard-coded so this recipe can be launched without a shared
# experiment-config module.
SEED = 2026
SEQUENCE_LENGTH = 8192
GLOBAL_BATCH_SIZE = 4 * 1024 * 1024  # 4,194,304 tokens.
...
# LB_LOSS_WEIGHT = 0.5
# LB_LOSS_WEIGHT = 0.02
RUN_VARIANT = "lbl-0p50-shared-1x2560"
...
def benchmark_num_flops_per_token(vocab_size: int, seq_len: int = SEQUENCE_LENGTH) -> int:
    ...
    # Layer 0 is dense; layers 1--9 are MoE.
...
def build_trainer_config(
    ...
    *,
    ...
    group = os.environ.get("TECH_REPORT_WANDB_GROUP", "token-gerrymandering-lbl-weight")
