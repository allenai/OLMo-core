# Tech-report operating point: Small-64E, 16 Mi GBS, random routing (alternate).
# Identical to OLMoE3-dev-s001.py except: RANDOM_ASSIGN = False -> RANDOM_ASSIGN = True; MICRO_BSZ = 3 -> MICRO_BSZ = 2; GLOBAL_BATCH_SIZE_SEQ = (8 * 8) * 2 * 24 -> GLOBAL_BATCH_SIZE_SEQ = (8 * 8) * 2 * 16.
import logging
import math
import os
import socket
