# Tech-report operating point: Medium-64E, 16 Mi GBS, random routing (headline row).
# Identical to OLMoE3-dev-m001.py except: NUM_EXPERTS = 96 -> NUM_EXPERTS = 64; GLOBAL_BATCH_SIZE_SEQ = (8 * 8) * 2 * 24 -> GLOBAL_BATCH_SIZE_SEQ = (8 * 8) * 2 * 16.
import logging
import math
import os
import socket
