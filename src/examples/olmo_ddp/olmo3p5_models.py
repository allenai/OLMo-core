"""Canonical small, medium and large OLMo 3.5 hybrid latent MoE shapes.
...
GEOMETRIES: dict[str, Geometry] = {
    "small": Geometry(
        ...
        n_heads=8,
        n_kv_heads=4,
        expected_active_params=794_233_472,
        expected_active_non_embedding_params=691_473_024,
        expected_total_params=12_496_341_632,
    ),
    "medium": Geometry(
        d_model=1536,
        n_layers=24,
        n_heads=16,
        n_kv_heads=8,
        expected_active_params=2_387_533_440,
        expected_active_non_embedding_params=2_233_392_768,
        expected_total_params=42_759_806_592,
    ),
    "large": Geometry(
        d_model=1536,
        n_layers=40,
        n_heads=16,
        n_kv_heads=8,
        expected_active_params=3_780_515_200,
        expected_active_non_embedding_params=3_626_374_528,
        expected_total_params=72_237_847_936,
    ),
}
...
def build_model_config(
    ...
    *,
    ...
    """Build a production geometry; explicitly disable EMO for downstream stages."""
    ...
    default_block = _moe_block(g, norm, _kda(g), emo if use_emo else None)
    attention_block = _moe_block(g, norm, _attention(g, norm), emo if use_emo else None)
