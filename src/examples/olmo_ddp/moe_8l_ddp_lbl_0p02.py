...
# JOB_ID=token-gerrymandering-lbl-0p02 WANDB_RUN_ID=token-gerrymandering-lbl-0p02 WANDB_RESUME=allow PYTHONPATH=/workspace/OLMo-core/src torchrun --standalone --nnodes=1 --nproc-per-node=8 /workspace/OLMo-core/src/examples/olmo_ddp/moe_8l_ddp_lbl_0p02.py token-gerrymandering-lbl-0p02
