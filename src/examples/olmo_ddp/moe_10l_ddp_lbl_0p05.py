...
# JOB_ID=token-gerrymandering-10l-lbl-0p05 WANDB_RUN_ID=token-gerrymandering-10l-lbl-0p05 WANDB_RESUME=allow PYTHONPATH=/workspace/OLMo-core/src torchrun --standalone --nnodes=1 --nproc-per-node=8 /workspace/OLMo-core/src/examples/olmo_ddp/moe_10l_ddp_lbl_0p05.py token-gerrymandering-10l-lbl-0p05
