...
class TestModelMergeCallbackValidation:
    """Tests for ModelMergeCallback validation logic."""

    def test_merge_last_n_steps_zero_raises_error(self):
    ...
    def test_merge_last_n_steps_negative_raises_error(self):
    ...
    def test_warn_for_truncated_windows(self, caplog):
...
class TestModelMergeCallbackOverlapDetection:
    """Tests for merge window overlap detection."""

    def test_overlapping_merge_windows_raises_error(self):
        ...
        callback = ModelMergeCallback(
            ...
            merge_last_n_steps=100,  # 100 step window - overlaps!
        )
    ...
    def test_non_overlapping_merge_windows_ok(self):
    ...
    def test_merge_windows_exact_boundary_ok(self):
    ...
    def test_single_merge_step_no_overlap_check(self):
