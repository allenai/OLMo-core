...
from olmo_core.utils import apply_to_tensors, get_all_tensors
...
def test_get_all_tensors(container, tensor_count):
    assert len(get_all_tensors(container)) == tensor_count
