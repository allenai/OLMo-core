...
cfg = VisionEncoderConfig(
    image_default_input_size=(28, 28), image_patch_size=4,
    image_emb_dim=64, image_num_heads=4, image_num_key_value_heads=4,
    image_num_layers=N, image_head_dim=16, image_mlp_dim=128,
    image_num_pos=50, use_cls_token=True,
)
...
print(f"delta                          : {a_e - b_e} elems "
      f"({100*(a_e-b_e)/max(a_e,1):.1f}%)")
...
cfg4 = VisionEncoderConfig(
    image_default_input_size=(28, 28), image_patch_size=4,
    image_emb_dim=64, image_num_heads=4, image_num_key_value_heads=4,
    image_num_layers=4, image_head_dim=16, image_mlp_dim=128,
    image_num_pos=50, use_cls_token=True,
)
