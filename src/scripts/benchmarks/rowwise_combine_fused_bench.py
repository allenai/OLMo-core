...
def main() -> None:
    ...
    baseline_gathered = torch.empty((args.rows, args.top_k, args.cols), device=device, dtype=dtype)
    ...
    close_baseline_gathered = torch.allclose(baseline_gathered, ref_gathered, atol=atol, rtol=rtol)
