...
# patch
MONKEY_PATCH_DECAY_START_TOKENS = int(
    (1000e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE
)  # None for disabled, or int((1000e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE) for starting at 1T tokens
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                "/workspace/checkpoint/OLMoE3-dev-260401-decay-1000B-100B_2560d3072a_24L2560M1280S_48E4K1S_p1/step*-avg",
            ],
        )
        .with_callback(
            "checkpointer",
