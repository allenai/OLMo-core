...
[b]Examples[/]
$ [i]python {sys.argv[0]} {SubCmd.launch} gs://ai2-llm/checkpoints/dirkg/OLMo2-7B-retrofit2-lowlr/step17882/ 100e9 ai2/augusta-google-1 --launch.num_nodes=2[/]
    """.strip()
    ...
    # Load OLMo 2 7B Retrofit module
    ...
    batch_size = retrofit_module.GLOBAL_BATCH_SIZE
    ...
    def build_trainer_config(common: CommonComponents) -> TrainerConfig:
        config = retrofit_module.build_trainer_config(common)
