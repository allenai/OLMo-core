...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                "/workspace/checkpoint/OLMoE3-abl-260322-005_1024d1024a_12L1024M1024S_64E4K1S_c1/step*0000",
                "/workspace/checkpoint/OLMoE3-abl-260322-005_1024d1024a_12L1024M1024S_64E4K1S_c1/step*5000",
                "/workspace/checkpoint/OLMoE3-abl-260322-005_1024d1024a_12L1024M1024S_64E4K1S_c1/step*052",
            ],
        )
        .with_callback(
            "checkpointer",
