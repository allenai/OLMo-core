...
GLOBAL_BATCH_SIZE_15M = (8 * 8) * (2) * 15 * SEQUENCE_LENGTH
...
LR_SCALE_ALPHA = 0.6
LR_15M = LR * (
    (GLOBAL_BATCH_SIZE_15M / (4 * 1024 * 1024)) ** 0.5
)  # lr at 15M tokens, for reference
LR = LR * ((24 / 15) ** LR_SCALE_ALPHA)  # lr is for X Million token
EXPERT_LR = LR
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            load_path="/workspace/checkpoint/OLMoE3-dev-260401_2560d3072a_24L2560M1280S_48E4K1S_p1-pin/step171000",
            save_overwrite=True,
