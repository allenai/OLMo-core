...
#
# Usage:
#   bash src/scripts/train/singletask_ladder/launch_singletask_10k_overnight.sh                    # submit all 20
...
SCRIPT_3V=src/scripts/train/singletask_ladder/Qwen3-4B-singletask-ladder-32k-10k-3variant-SFT.py
SCRIPT_DC=src/scripts/train/singletask_ladder/Qwen3-4B-docchunk-singletask-ladder-10k-SFT.py
