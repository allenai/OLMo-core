...
# patch
MONKEY_PATCH_DECAY_START_TOKENS = int((2000e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE) # None for disabled, or int((1000e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE) for starting at 1T tokens
