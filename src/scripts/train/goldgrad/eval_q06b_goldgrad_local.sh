...
#
#   bash src/scripts/train/goldgrad/eval_q06b_goldgrad_local.sh n100
#   RUNS="q06b-goldgrad-fa-n20-full ..." bash src/scripts/train/goldgrad/eval_q06b_goldgrad_local.sh n20
set -uo pipefail
