"""
Qwen3-30B-A3B converted-checkpoint training on the Qwen-retokenized shard.
"""
...
os.environ["QWEN_TOKENIZER_ID"] = "Qwen/Qwen3-30B-A3B"
os.environ["QWEN_MODEL_SCALE"] = "full"
os.environ.setdefault("QWEN_LOAD_PATH", "/workspace/checkpoint/qwen3-30b-a3b-olmo")
