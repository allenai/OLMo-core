...
Run locally (no GPU / no weka needed)::
    ...
    PYTHONPATH=src python src/scripts/train/probes/sanity_check_packing.py
    PYTHONPATH=src python src/scripts/train/probes/sanity_check_packing.py --seq-len 256
