...
# stage 1 - 4M - 0-37 tokens
# MICRO_BSZ = 2
# GLOBAL_BATCH_SIZE_SEQ=(8 * 8) * (2) * 4
# NO LR_REF_BSZ=4M

# stage 2 - 8M - 37-xB token
# MICRO_BSZ = 2
# GLOBAL_BATCH_SIZE_SEQ=(8 * 8) * (2) * 8
# NO LR_REF_BSZ=4M

# stage 2 - 16M - x-500B token
MICRO_BSZ = 4
GLOBAL_BATCH_SIZE_SEQ = (8 * 8) * (2) * 16
# NO LR_REF_BSZ=4M

GLOBAL_BATCH_SIZE = (GLOBAL_BATCH_SIZE_SEQ) * SEQUENCE_LENGTH
NUM_MICRO_BATCHES = GLOBAL_BATCH_SIZE_SEQ // (REF_NUM_NODES * 6) // MICRO_BSZ * PP_DIM

GLOBAL_BATCH_TOKENS_IN_M = GLOBAL_BATCH_SIZE // 1024 // 1024


SCHED_WARMUP_TOKENS = int((10e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE)
SCHED_FAST_DECAY_TOKENS = int((10e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE)
SCHED_LONG_DECAY_TOKENS = int((5980e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step5000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step6000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step7000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step8000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step9000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step10000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step11000",
                "/workspace/checkpoint/OLMoE3-dev-260330_2560d4096a_39L2560M2560S_128E4K1S_p1/step12000",
            ],
        )
        .with_callback(
            "checkpointer",
