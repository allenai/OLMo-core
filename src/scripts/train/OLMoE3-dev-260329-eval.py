...
SHARED_MLP_HIDDEN_SIZE = 2048 + 1024  # Hidden size for shared MLP (or dense branch MLP in arctic) in MoE blocks
...
# stage 1 - 4M - 0-100B token
MICRO_BSZ = 2
GLOBAL_BATCH_SIZE_SEQ=(8 * 8) * (2) * 4
# NO LR_REF_BSZ=8M

# stage 2 - 8M - 100-500B token
# MICRO_BSZ = 2
...
LR= 5e-4
LR=LR * math.sqrt(GLOBAL_BATCH_SIZE / (8 * 1024 * 1024)) # lr is for X Million token
...
def build_model_config(common: CommonComponents) -> TransformerConfig:
    ...
    config = MoEFusedV2TransformerConfig(
        ...
        # recompute_block_keys=["0"], # recompute dense layer
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step5000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step6000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step7000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step8000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step9000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step10000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step11000",
                # "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step12000",
                "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step13000",
                "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step13000",
                "/workspace/checkpoint/OLMoE3-dev-260329_3584d4096a_32L2048M3072S_96E4K1S_p2/step15000",
            ]
        )
        .with_callback(
            "checkpointer",
