...
def build_experiment_config(cli_context: CliContext) -> ExperimentConfig:
    ...
    beaker_launch_config: Optional[BeakerLaunchConfig] = build_launch_config(
        ...
        # attention over the whole sequence with all 16 heads. 8 nodes × 8 GPUs = 64 DP replicas
        # = the 64 instances/step → grad-accum 1.
        num_nodes=8,
    )
...
if __name__ == "__main__":
    """
    Qwen3-0.6B + FAST landmark attention at 64k on the 15B dolma3_longmino sample (8 nodes, urgent).
