...
if __name__ == "__main__":
    ...
    Examples:
        python src/scripts/train/Qwen3/Qwen3-4B-fast-landmark_single_node.py dry_run my-run ai2/jupiter-cirrascale-2
        python src/scripts/train/Qwen3/Qwen3-4B-fast-landmark_single_node.py launch my-run ai2/jupiter-cirrascale-2
    """
