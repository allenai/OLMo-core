...
# Qwen3-0.6B DENSE baseline at 64k context on the 15B-token dolma3_longmino sample. Uses YaRN
# (factor 2) to extend the native 32k context to 64k. The 0.6B analog of
# Qwen3-4B-base-dense-dolma3longmino.py; paired with the 0.6B fast-landmark scripts.
...
def build_experiment_config(cli_context: CliContext) -> ExperimentConfig:
    ...
    # Qwen3-0.6B with YaRN context extension: native 32k → 64k, full (flash-attn 2) attention.
...
if __name__ == "__main__":
    """
    Qwen3-0.6B dense (YaRN 32k→64k) baseline at 64k on the 15B dolma3_longmino sample (8 nodes,
    urgent). The 0.6B analog of Qwen3-4B-base-dense-dolma3longmino.py.

        python src/scripts/train/Qwen3/Qwen3-0.6B-base-dense-dolma3longmino.py \\
