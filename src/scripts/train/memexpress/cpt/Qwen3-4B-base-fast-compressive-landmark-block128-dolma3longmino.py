...
# Block-size sweep variant: landmark block size 128 (default is 64; see
# Qwen3-4B-base-fast-compressive-landmark-dolma3longmino.py).
MEM_FREQ = 127
...
if __name__ == "__main__":
    ...
    (2 nodes, urgent). Block-size sweep variant: landmark block size 128 (mem_freq=127). Same setup
    ...
    a GPU node (the fast kernel imports triton).
        ...
        python src/scripts/train/Qwen3/Qwen3-4B-base-fast-compressive-landmark-block128-dolma3longmino.py \\
