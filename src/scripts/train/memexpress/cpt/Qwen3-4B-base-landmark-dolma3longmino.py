...
# Qwen3-4B + LANDMARK attention at 64k context on the 15B-token dolma3_longmino sample.
# Landmark handles long range via its block-gated softmax (no YaRN/RoPE extension needed).
MEM_FREQ = 63
...
if __name__ == "__main__":
    """
    Qwen3-4B + landmark attention at 64k on the 15B dolma3_longmino sample (4 nodes, urgent).

        python src/scripts/train/memexpress/cpt/Qwen3-4B-base-landmark-dolma3longmino.py \\
