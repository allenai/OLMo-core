...
# Block-size sweep variant: landmark block size 32 (default is 64; see
...
if __name__ == "__main__":
    ...
    (2 nodes, urgent). Block-size sweep variant: landmark block size 32 (mem_freq=31). Same setup
    ...
    a GPU node (the fast kernel imports triton).
        ...
        python src/scripts/train/Qwen3/Qwen3-4B-base-fast-compressive-landmark-block32-dolma3longmino.py \\
