...
if __name__ == "__main__":
    ...
    Examples:
        Render the config and exit:
            python src/scripts/train/memexpress/cpt/Qwen3-4B-long-context.py dry_run my-run ai2/jupiter-cirrascale-2

        Launch on Beaker with 4 nodes:
            python src/scripts/train/memexpress/cpt/Qwen3-4B-long-context.py launch my-run ai2/jupiter-cirrascale-2
