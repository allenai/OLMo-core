"""
SummTokenSFT -- **summ-p25** arm (Beaker/gantry).

MODE 1: a static random 25% of examples are causal each forward.
...
summary-repaired first.
    ...
    PYTHONPATH=src python src/scripts/train/memexpress/sft_summtoken/Qwen3.5-4B-summ-p25-5task-SFT.py \\
        dry_run q35-4b-summ-p25-5task ai2/jupiter-cirrascale-2
    PYTHONPATH=src python src/scripts/train/memexpress/sft_summtoken/Qwen3.5-4B-summ-p25-5task-SFT.py \\
        launch_prep q35-4b-summ-p25-5task-prep ai2/jupiter-cirrascale-2
    PYTHONPATH=src python src/scripts/train/memexpress/sft_summtoken/Qwen3.5-4B-summ-p25-5task-SFT.py \\
        launch q35-4b-summ-p25-5task ai2/jupiter-cirrascale-2 \\
...
if __name__ == "__main__":
    main(config_builder=partial(build_summtoken_experiment, arm="summ-p25"))
