"""
Document-chunked 5-task 32k no-CPT SFT (Beaker/gantry) -- LANDMARK (DocumentLandmarkAttention, eager grouped-softmax), landmark docchunk data + fast-landmark base.
...
from the box markers and needs one EOS-terminated example per instance).
    ...
    PYTHONPATH=src python src/scripts/train/memexpress/sft_docchunk/Qwen3-4B-docchunk-landmark-5task-32k-nocpt-SFT.py \\
        launch q4b-docchunk-landmark-5task-32k-nocpt ai2/neptune-cirrascale
"""
...
if __name__ == "__main__":
    main(config_builder=partial(build_docchunk_experiment, variant="landmark"))
