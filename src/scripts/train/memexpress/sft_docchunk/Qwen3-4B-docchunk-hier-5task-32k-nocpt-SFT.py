"""
Document-chunked 5-task 32k no-CPT SFT (Beaker/gantry) -- HIERARCHICAL-DILATED (DocumentChunkedAttention, dilation_n=4,m=2), dense docchunk data + dense base.
...
from the box markers and needs one EOS-terminated example per instance).
    ...
    PYTHONPATH=src python src/scripts/train/memexpress/sft_docchunk/Qwen3-4B-docchunk-hier-5task-32k-nocpt-SFT.py \\
        launch q4b-docchunk-hier-5task-32k-nocpt ai2/neptune-cirrascale
"""
