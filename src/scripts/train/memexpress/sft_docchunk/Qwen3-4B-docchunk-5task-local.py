...
Variants (mirror src/scripts/train/memexpress/sft_docchunk/_docchunk_5task_32k_nocpt_common.py):
...
Run (8x H200, full FSDP shard)::
    ...
    PYTHONPATH=<repo>/src torchrun --nproc_per_node=8 \\
      src/scripts/train/memexpress/sft_docchunk/Qwen3-4B-docchunk-5task-local.py \\
