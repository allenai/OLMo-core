"""Dense vs its paired arm: contradiction-only, three epochs through 256K.
...
def build_experiment_config(cli_context):
    """Select the dense arm of the shared contradiction-only recipe."""
    return build_contradiction_experiment(cli_context, arm="dense")
