...
#
# Usage:
#   bash src/scripts/train/memexpress/singletask_ladder/launch_singletask_10k_3variant.sh                 # submit all 15
...
SCRIPT=src/scripts/train/memexpress/singletask_ladder/Qwen3-4B-singletask-ladder-32k-10k-3variant-SFT.py
