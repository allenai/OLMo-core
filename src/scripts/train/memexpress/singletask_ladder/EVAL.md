...
python src/scripts/train/memexpress/singletask_ladder/run_q4b_beaker_multirung_eval.py \
...
```bash
bash src/scripts/train/memexpress/singletask_ladder/upload_lc_eval_bundle.sh    # push data to s3
