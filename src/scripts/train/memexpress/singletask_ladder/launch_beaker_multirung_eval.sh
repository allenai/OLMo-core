...
#
# Usage:
#   bash src/scripts/train/memexpress/singletask_ladder/launch_beaker_multirung_eval.sh                       # all variants x tasks
...
LAUNCHER="$REPO/src/scripts/train/memexpress/singletask_ladder/run_q4b_beaker_multirung_eval.py"
