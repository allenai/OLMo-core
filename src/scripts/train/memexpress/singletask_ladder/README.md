...
```bash
# from the repo root
bash src/scripts/train/memexpress/singletask_ladder/launch_singletask_10k_overnight.sh        # submit matrix (jupiter)
DRY=1 bash src/scripts/train/memexpress/singletask_ladder/launch_singletask_10k_overnight.sh   # dry-run
# evals fire per finished checkpoint:
bash src/scripts/train/memexpress/singletask_ladder/launch_beaker_multirung_eval.sh
```
