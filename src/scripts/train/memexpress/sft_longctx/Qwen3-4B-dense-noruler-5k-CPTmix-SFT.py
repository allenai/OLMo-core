...
# small-scale version):
#   * SEQUENCE_LENGTH = 5120 (fast); native Qwen3 ctx (32k) covers this. YaRN kept to match the
...
SEQUENCE_LENGTH = 5120  # short, fast packed window (well within Qwen3's native 32k)

# 1k SFT shards that EXCLUDE ruler (and held-out tasks), capped at 4096 tokens/instance.
SFT_DATA_ROOT = "/weka/oe-training-default/ai2-llm/checkpoints/prasanns/suite_it_sft_qwen/combined_debug_noruler_5k"
...
if __name__ == "__main__":
    ...
    mixing continued-pretraining text mitigates RULER forgetting.
        ...
        python src/scripts/train/memexpress/sft_longctx/Qwen3-4B-dense-noruler-4k-CPTmix-SFT.py \\
            launch q4b-dense-noruler-5k-cptmix-sft ai2/jupiter
    """
