...
# ---------------------------------------------------------------------------
# Unified task-suite SFT for Qwen3-4B + SPARSE LANDMARK attention, with correctly-masked
# sequence packing (each suite example is its own document; no cross-document attention).
#
# This is the multitask counterpart of Qwen3-4B-sparse-landmark-packed-SFT.py: the data is the
...
if __name__ == "__main__":
    """
    Single-epoch packed (intra-document masked) unified-suite SFT of Qwen3-4B + sparse-landmark.

        python src/scripts/train/memexpress/sft_longctx/Qwen3-4B-sparse-landmark-unified-SFT.py \\
            launch q4b-sparse-landmark-unified-sft ai2/jupiter-cirrascale-2
    """
