...
DATA_ROOT = "/weka/oe-training-default/ai2-llm/checkpoints/prasanns/suite_it_sft_qwen/combined_debug_noruler_5k"
...
if __name__ == "__main__":
    ...
    Small-scale (1k, ruler-excluded) dense SFT of Qwen3-4B at 4k seq, to probe RULER forgetting.
        ...
        python src/scripts/train/memexpress/sft_longctx/Qwen3-4B-dense-noruler-4k-SFT.py \\
            launch q4b-dense-noruler-5k-sft ai2/jupiter
    """
