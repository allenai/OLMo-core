    ...
    *,
    ...
    try:
        ...
        block = _build_block(
            ...
            rowwise_get_nblocks=args.rowwise_get_nblocks,
            rowwise_put_nblocks=args.rowwise_put_nblocks,
            rowwise_weighted_put_nblocks=args.rowwise_weighted_put_nblocks,
