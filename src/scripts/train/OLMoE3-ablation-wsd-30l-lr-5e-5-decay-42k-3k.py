...
START_STEP = 42000
DECAY_STEPS= 3000
# LOAD_CKPT = f'gs://ai2-llm/checkpoints/OLMoE3-ablation-wsd-30l-lr-5e-5/step{START_STEP}'
LOAD_CKPT = f'/workspace/tmp/OLMoE3-ablation-wsd-30l-lr-5e-5/step{START_STEP}'
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            max_duration=Duration.steps(START_STEP+ DECAY_STEPS),  # use steps instead of tokens
