...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        SourceMixtureConfig(
            ...
            target_ratio=1.0,
            paths=[
                f"s3://ai2-llm/preprocessed/cc_all_dressed/all_dressed_v5/ablation_pools/suffix_arrays/2rep_5rep/sa_reshard_range-labeled_filtered/allenai/dolma2-tokenizer/*.npy"
            ],
        )
    ]
)
