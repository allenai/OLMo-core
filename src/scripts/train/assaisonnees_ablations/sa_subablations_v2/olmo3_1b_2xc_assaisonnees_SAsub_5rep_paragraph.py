...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        SourceMixtureConfig(
            source_name="5rep_sa_paragraph_filter",
            target_ratio=1.0,
            paths=[
                f"s3://ai2-llm/preprocessed/cc_all_dressed/all_dressed_v5/ablation_pools/suffix_arrays/2rep_5rep_v2/5rep_sa_paragraph_filter/allenai/dolma2-tokenizer/*.npy"
            ],
        )
    ]
)
