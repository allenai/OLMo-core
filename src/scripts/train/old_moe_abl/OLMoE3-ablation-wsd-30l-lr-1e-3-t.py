...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        ...
        .with_callback(
            ...
            BatchSizeSchedulerCallback(
                batch_sizes=[
                    # GLOBAL_BATCH_SIZE//4, GLOBAL_BATCH_SIZE//2,
                             GLOBAL_BATCH_SIZE, GLOBAL_BATCH_SIZE * 2, GLOBAL_BATCH_SIZE * 4],
                schedule=[
                    Duration.tokens(0),
                    # Duration.tokens(GLOBAL_BATCH_SIZE//4 * 300),
                    # Duration.tokens(GLOBAL_BATCH_SIZE//4 * 300 + GLOBAL_BATCH_SIZE//2 * 300),
                    Duration.tokens(167_772_160_000), # 40k steps
                    Duration.tokens(503_316_480_000), # 120k steps
                ],
            ),
        )
