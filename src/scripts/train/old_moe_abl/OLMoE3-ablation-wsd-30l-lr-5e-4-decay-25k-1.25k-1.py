...
START_STEP = 25000
DECAY_STEPS = 1250
LOAD_CKPT = f"/weka/oe-training-default/tianhua/ws-megatron/tmp/OLMoE3-ablation-wsd-30l-lr-5e-4-s2/step{START_STEP}"
TOTAL_TOKENS = (
...
EVAL_INTERVAL = 250
## change "decay=(int(50e9 / GLOBAL_BATCH_SIZE))""
## add load_path=LOAD_CKPT,  # Load from the before decay
############
