...
from olmo_core.nn.feed_forward import FeedForwardConfig, DenseMoEFeedForwardConfig
...
MAX_DURATION = int(300e9)  # int(6e12), don't forget to adjust the LR when you increase this
EVAL_INTERVAL = 1000
NUM_EXPERTS = 1
TOP_K = 1
NUM_LAYERS=16
...
MLP_HIDDEN_SIZE = 11008  # Hidden size for shared MLP in MoE blocks
...
def build_model_config(common: CommonComponents) -> TransformerConfig:
    ...
    config = TransformerConfig.llama_like(
        ...
        # feed_forward=DenseMoEFeedForwardConfig(hidden_size=MLP_HIDDEN_SIZE, bias=False),
        feed_forward=FeedForwardConfig(hidden_size=(MLP_HIDDEN_SIZE), bias=False),
        init_std=0.01,
    )
