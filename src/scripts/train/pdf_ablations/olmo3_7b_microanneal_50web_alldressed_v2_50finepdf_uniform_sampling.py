...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            source_name="finepdf_uniform_sampling",
            target_ratio=0.5,
            paths=[
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0000/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0001/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0002/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0003/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0004/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0005/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0006/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0007/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0008/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0009/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0010/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0011/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0012/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0013/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0014/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0015/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0016/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0017/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0018/*.npy",
               f"s3://ai2-llm/preprocessed/HuggingFaceFW_finepdfs/{TOKENIZER_CONFIG.identifier}/ufw_0019/*.npy",
            ],
        ),
    ]
)
