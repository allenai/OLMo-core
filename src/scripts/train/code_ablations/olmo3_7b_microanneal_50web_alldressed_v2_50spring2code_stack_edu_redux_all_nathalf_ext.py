...
# At the spring 2 code prefix, there are 40,507 .npy files totaling ~5,081.75 GB (~5.08 TB) at that S3 prefix.
#     of which 38,351 .npy files with quality_ in the path, totaling ~3,434.30 GB (~3.43 TB).
#     of which 19,144 .npy files matching quality_p50 through quality_p95, totaling ~1,789.53 GB (~1.79 TB).
STACK_EDU_LANGS = (
    "Blade",
    "Bluespec",
    "C",
