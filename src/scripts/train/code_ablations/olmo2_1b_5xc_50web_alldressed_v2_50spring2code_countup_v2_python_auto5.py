...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            source_name="spring2code-countup_criteria_v2-python_auto5",
            target_ratio=0.5,
            max_repetition_ratio=5,
            paths=[
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_11/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_12/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_13/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_14/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_15/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_16/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_17/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_18/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_19/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_auto5_filtered/Python/step_final/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
