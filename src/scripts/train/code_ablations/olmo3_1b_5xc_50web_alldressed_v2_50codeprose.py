...
SPONGE_211_PREFIX = "s3://ai2-llm/preprocessed/sponge_211"
    ...
    sources=[
        ...
        SourceMixtureConfig(
            ...
            paths=[
                ...
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p60/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p65/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p70/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p75/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p80/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p85/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p90/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_code_prose_code_prose_tagged_partitioned/quality_p95/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p50/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p55/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p60/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p65/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p70/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p75/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p80/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p85/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p90/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"{SPONGE_211_PREFIX}_non-software-development_code_prose_code_prose_tagged_partitioned/quality_p95/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
