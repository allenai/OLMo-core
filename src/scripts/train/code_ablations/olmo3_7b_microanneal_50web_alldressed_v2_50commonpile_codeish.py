...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            source_name="commonpile_codeish",
            target_ratio=0.5,
            paths=[
                f"s3://ai2-llm/preprocessed/common-pile_codetextish/v0/common-pile_github_archive_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_codetextish/v0/common-pile_stackexchange/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_codetextish/v0/common-pile_ubuntu_irc_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
