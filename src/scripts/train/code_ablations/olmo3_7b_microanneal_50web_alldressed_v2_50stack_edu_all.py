    ...
    sources=[
        ...
        SourceMixtureConfig(
            ...
            paths=[
                ...
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Markdown/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/PHP/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Python/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Ruby/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Rust/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Shell/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/SQL/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/Swift/*.npy",
                f"s3://ai2-llm/preprocessed/stack-edu/{TOKENIZER_CONFIG.identifier}/TypeScript/*.npy",
            ],
        ),
    ]
)
