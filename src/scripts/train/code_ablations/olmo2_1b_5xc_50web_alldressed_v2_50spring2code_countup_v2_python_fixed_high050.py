...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            ...
            paths=[
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_filtered_fixed_high050/Python/{TOKENIZER_CONFIG.identifier}/*.npy"
            ],
        ),
    ]
)
