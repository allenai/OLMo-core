...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            ...
            target_ratio=0.5,
            paths=[
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_12/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_13/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_14/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_15/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_16/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_17/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_18/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/the-stack-v2/spring2code_v2/minhash_v2_annotated_reshard_qc_tagged_multilabel_filtered_no_len/Python/step_final/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
