"""Standalone eight-layer, 128-expert EP1 profile without shared experts."""
...
def _set_default_triton_cache_dir() -> None:
    ...
    job_id = os.environ.get("JOB_ID", "moe-8l-ep1-no-shared-profile")
...
# Standalone no-expert-parallel control matched to the EP8 profiles.
SEED = 2026
    ...
    return (
        TrainerConfig(
            save_folder=str(
                ...
                / f"{common.run_name}-ep1-no-shared-profile"
            ),
            save_overwrite=True,
            no_checkpoints=True,
            no_evals=True,
