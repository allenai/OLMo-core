...
# JOB_ID=token-gerrymandering-lbl-0p20 WANDB_RUN_ID=token-gerrymandering-lbl-0p20 WANDB_RESUME=allow PYTHONPATH=/workspace/OLMo-core/src torchrun --standalone --nnodes=1 --nproc-per-node=8 /workspace/OLMo-core/src/scripts/train/tech_report/moe_8l_ddp_lbl_0p20.py train token-gerrymandering-lbl-0p20 localhost
