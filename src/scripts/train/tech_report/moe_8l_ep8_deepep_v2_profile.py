"""Standalone eight-layer, 128-expert DeepEP-v2 EP8 profile."""
...
def _set_default_triton_cache_dir() -> None:
    ...
    job_id = os.environ.get("JOB_ID", "moe-8l-ep8-deepep-v2-profile")
    ...
    return (
        TrainerConfig(
            save_folder=str(
                ...
                / f"{common.run_name}-ep8-deepep-v2-profile"
            ),
            save_overwrite=True,
            no_checkpoints=True,
            no_evals=True,
