"""Standalone eight-layer, 128-expert DeepEP-v2 EP8 profile without shared experts."""
...
def _set_default_triton_cache_dir() -> None:
    ...
    job_id = os.environ.get("JOB_ID", "moe-8l-ep8-deepep-v2-no-shared-profile")
...
# synchronized and rowwise entry points.
SEED = 2026
    ...
    return (
        TrainerConfig(
            save_folder=str(
                ...
                / f"{common.run_name}-ep8-deepep-v2-no-shared-profile"
            ),
            save_overwrite=True,
            no_checkpoints=True,
            no_evals=True,
