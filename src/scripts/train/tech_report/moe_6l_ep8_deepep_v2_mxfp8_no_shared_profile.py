"""Standalone six-layer, 128-expert DeepEP-v2 MXFP8 EP8 profile without shared experts."""
...
def _set_default_triton_cache_dir() -> None:
    ...
    job_id = os.environ.get("JOB_ID", "moe-6l-ep8-deepep-v2-mxfp8-no-shared-profile")
...
# Standalone, matched six-layer MXFP8 experiment constants.
SEED = 2026
...
EP_DEGREE = 8
EP_PATH = ExpertParallelPath.deepep_v2
DEEPEP_PATH = os.environ.get("OLMO_DEEPEP_PATH", "/workspace/DeepEP")
...
def build_model_config(common: CommonComponents) -> OLMoDDPModelConfig:
    ...
    moe_block = OLMoDDPTransformerBlockConfig(
        ...
        ep=ExpertParallelConfig(
            ...
            deepep=DeepEPConfig(path=DEEPEP_PATH),
        ),
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    return (
        TrainerConfig(
            save_folder=str(
                Path("/workspace/checkpoint/tech_report")
                / f"{common.run_name}-6l-ep8-deepep-v2-mxfp8-no-shared-profile"
            ),
            save_overwrite=True,
            no_checkpoints=True,
            no_evals=True,
        ...
        .with_callback(
            ...
            WandBCallback(
                ...
                group=os.environ.get("TECH_REPORT_WANDB_GROUP", "moe-6l-ep8-mxfp8-profiles"),
                entity="ai2-llm",
