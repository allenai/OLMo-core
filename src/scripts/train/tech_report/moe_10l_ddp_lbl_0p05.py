...
# JOB_ID=token-gerrymandering-10l-lbl-0p05 WANDB_RUN_ID=token-gerrymandering-10l-lbl-0p05 WANDB_RESUME=allow PYTHONPATH=/workspace/OLMo-core/src torchrun --standalone --nnodes=1 --nproc-per-node=8 /workspace/OLMo-core/src/scripts/train/tech_report/moe_10l_ddp_lbl_0p05.py train token-gerrymandering-10l-lbl-0p05 localhost
