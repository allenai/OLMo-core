"""Standalone six-layer, 128-expert rowwise-NVSHMEM MXFP8 EP8 profile without shared experts."""
...
def _set_default_triton_cache_dir() -> None:
    ...
    job_id = os.environ.get("JOB_ID", "moe-6l-ep8-rowwise-mxfp8-no-shared-profile")
    ...
    return (
        TrainerConfig(
            save_folder=str(
                ...
                / f"{common.run_name}-6l-ep8-rowwise-mxfp8-no-shared-profile"
            ),
            save_overwrite=True,
            no_checkpoints=True,
            no_evals=True,
