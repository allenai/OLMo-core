"""Baseline full-attention ladder on v02 data with data-loader seed=3.

Identical to ``baseline_v02_full_attn_ladder.py`` except
``ComposableDataLoaderConfig.seed`` is set to 3.
...
``baseline_v02_seed2_full_attn_ladder.py`` (and the existing
