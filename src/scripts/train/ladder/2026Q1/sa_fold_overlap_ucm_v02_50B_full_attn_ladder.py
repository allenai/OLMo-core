"""SA fold-overlap UCM (uncompressed-simulated, variant 3) ladder on v02.
...
PATHS = [
    "/weka/oe-training-default/ai2-llm/suffix-arrays/preprocessed/dolma2-0625-v02/sa-fold-overlap-ucm-50B/allenai/dolma2-tokenizer/*.npy",
]
