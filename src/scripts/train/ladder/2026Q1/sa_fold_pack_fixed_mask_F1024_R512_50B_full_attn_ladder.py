"""SA fold-pack-fixed MASK F=1024 R=512 50B — neighborhood-packed MASK on fixed-len SA neighbors.
...
divergent tails). K_target = F/R = 2 expected SA neighbors per
anchor (variable due to compression).

Pairs against sa-fold-overlap-mask-v02-F1024-50B (single-pair MASK at
same F) and sa-chunk-shuffle-F1024-mask-50B (non-overlap baseline) for
...
BASE = (
    ...
    "dolma2-0625-v02/sa-fold-pack-fixed-mask-F1024-R512-50B/allenai/dolma2-tokenizer"
)
