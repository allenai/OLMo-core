"""SA chunk-shuffle ICL F=2048 50B — non-overlap baseline for fold-overlap F=2048.

K = seq_len / F = 4 random F-token chunks per instance from the SA tokenized
...
sa-fold-overlap-icl-v02-F2048-50B for the diversity-vs-overlap comparison.
...
PATHS = [
    "/weka/oe-training-default/ai2-llm/suffix-arrays/preprocessed/dolma2-0625-v02/sa-chunk-shuffle-F2048-icl-50B/allenai/dolma2-tokenizer/*.npy",
]
