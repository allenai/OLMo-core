"""Baseline full-attention ladder on v02 data with data-loader seed=1.

Identical to ``baseline_v02_full_attn_ladder.py`` except
``ComposableDataLoaderConfig.seed`` is set to 1.

Motivation: seed-noise calibration for the 190M / 2xC C4 CE comparator.
Run alongside ``baseline_v02_seed2_full_attn_ladder.py`` and
