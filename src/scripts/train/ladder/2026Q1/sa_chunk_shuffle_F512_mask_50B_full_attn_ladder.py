"""SA chunk-shuffle MASK F=512 50B — non-overlap baseline for fold-overlap F=512.

K = seq_len / F = 16 random F-token chunks per instance from the SA
...
SA-neighbor overlap content. Pairs 1:1 with sa-fold-overlap-mask-v02-F512-50B.
...
BASE = (
    ...
    "dolma2-0625-v02/sa-chunk-shuffle-F512-mask-50B/allenai/dolma2-tokenizer"
)
