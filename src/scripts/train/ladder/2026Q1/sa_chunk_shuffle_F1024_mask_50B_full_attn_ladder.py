"""SA chunk-shuffle MASK F=1024 50B — non-overlap baseline for fold-overlap F=1024.

K = seq_len / F = 8 random F-token chunks per instance from the SA
...
SA-neighbor overlap content. Pairs 1:1 with sa-fold-overlap-mask-v02-F1024-50B.
...
BASE = (
    ...
    "dolma2-0625-v02/sa-chunk-shuffle-F1024-mask-50B/allenai/dolma2-tokenizer"
)
