...
ICL_OVERLAP_WO_REPLACE_PATHS = [
    "/weka/oe-training-default/ai2-llm/suffix-arrays/preprocessed/dolma2-0625-v01/icl-overlap-max-suffix-8192-eos-fix-wo-replace/allenai/dolma2-tokenizer/*.npy",
]
                    ...
                    source=ConcatAndChunkInstanceSourceConfig(
                        sources=[
                            NumpyDocumentSourceConfig(
                                source_paths=ICL_OVERLAP_WO_REPLACE_PATHS,
                                tokenizer=tokenizer,
                            ),
                        ],
