...
on v02 — N=2 folds, anchor:adj ratio = 1:1.

v2 (task #1 bug-fix): vis_limit uses scope_end_excl (no +1) and label_mask conditions on `L_k == 0 or is_fallback` for ALL k, matching packed-mask v2 convention. v1 (LA-N2-R1-50B Weka path) preserved for direct comparison.
...
SA_FOLD_MASK_BASE = (
    ...
    "dolma2-0625-v02/sa-fold-overlap-mask-LA-N2-R1-v2-50B/allenai/dolma2-tokenizer"
)
