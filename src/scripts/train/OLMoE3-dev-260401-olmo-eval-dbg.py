    ...
    config = MoEFusedV2TransformerConfig(
        ...
        block=MoEFusedV2TransformerBlockConfig(
            ...
            routed_experts_router=MoERouterConfigV2(
                ...
                restore_weight_scale=True,  # NOTE: megatron does not support this
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                # "/workspace/checkpoint/meg_24L_48N1S4K_2560H-11520F-1280S_24H_8192L-dev-cap1.25/olmo_cvt/iter_0092000",
