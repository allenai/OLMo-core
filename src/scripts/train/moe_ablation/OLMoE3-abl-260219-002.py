...
TAG = "ns" if USE_NO_SYNC_EP else "s"
...
def build_train_module_config(common: CommonComponents) -> MoEV2TransformerTrainModuleConfig:
    ...
    return MoEV2TransformerTrainModuleConfig(
        ...
        scheduler=CosWithWarmup(
            warmup_steps=max(int(10 * 1024 * 1024 * 1024 / GLOBAL_BATCH_SIZE), 200)
        ),  # warmup in tokens
    )
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            load_path="/workspace/checkpoint/OLMoE3-abl-260219-001_1024d1024a_6L768M768S_32E4K1S_s/step0",
