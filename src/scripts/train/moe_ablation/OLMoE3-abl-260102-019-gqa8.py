"""
Fork from 010: 4@32 experts -> 2@16 bigger experts, disable eval to run locally MICRO_BSZ = 16->8
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            load_path="/workspace/checkpoint/OLMoE3-abl-260102-019_1024d1024a_12L1536M768S_16E2K1S_abl/step2300-GQA-8",
            save_overwrite=True,
