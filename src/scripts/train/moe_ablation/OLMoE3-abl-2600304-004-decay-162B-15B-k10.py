...
EXPERT_LR = LR * math.sqrt(OLD_TOP_K / NUM_EXPERTS)  # scale lr for expert params
...
# early decay patch
MONKEY_PATCH_DECAY_START_TOKENS = int(162e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE
MONKEY_PATCH_DECAY_DURATION_TOKENS = int((15e9 // GLOBAL_BATCH_SIZE) * GLOBAL_BATCH_SIZE)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            load_path='/workspace/checkpoint/OLMoE3-abl-2600304-004_1536d2048a_32L1280M1024S_80E3K1S_cheap4/step29000',
