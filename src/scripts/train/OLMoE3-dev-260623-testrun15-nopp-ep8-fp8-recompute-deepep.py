...
os.environ.setdefault(
    ...
    "testrun15-nopp-ep8-fp8-recompute-deepep",
)
os.environ.setdefault("OLMOE3_TESTRUN_MAX_DURATION", "2048")
os.environ.setdefault("OLMOE3_TESTRUN_EP_DIM", "8")
...
os.environ.setdefault("OLMOE3_TESTRUN_GLOBAL_BATCH_SIZE_SEQ", "8")
