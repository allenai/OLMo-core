...
if __name__ == "__main__":
    ...
    if run_name == "copy-mlp-1e-4":
        ...
        global_args['UPCYCLE_PATH'] = '/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp'
    elif run_name == "virtual-group-1e-4":
    ...
    elif run_name == "virtual-group-init-exact-1e-4":
        global_args['NUM_EXPERTS'] = 32
        global_args['TOP_K'] = 4
        global_args['MOE_EXPANSION_FACTOR'] = 1
    ...
    elif run_name == "copy-mlp-as-shared-expert-type1-1e-4":
        global_args['NUM_EXPERTS'] = 32
        global_args['TOP_K'] = 8
        global_args['MOE_EXPANSION_FACTOR'] = 1
        global_args['SHARED_EXPERT_EXPANSION_FACTOR'] = 4
        global_args['UPCYCLE_PATH'] = '/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type1'
        build_model_config_partial = partial(
            build_model_config,
            routed_expert_norm=False,
            shared_expert_norm=False,
    ...
    elif run_name == "copy-mlp-as-shared-expert-type3-1e-4":
        global_args['NUM_EXPERTS'] = 32
        global_args['TOP_K'] = 8
        global_args['MOE_EXPANSION_FACTOR'] = 1
        global_args['SHARED_EXPERT_EXPANSION_FACTOR'] = 4
        ...
        global_args['UPCYCLE_PATH'] = '/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type3'
        
    elif run_name == "copy-mlp-as-shared-expert-type4-1e-4":
        global_args['NUM_EXPERTS'] = 32
        global_args['TOP_K'] = 8
        global_args['MOE_EXPANSION_FACTOR'] = 1
        global_args['SHARED_EXPERT_EXPANSION_FACTOR'] = 4
        ...
        global_args['UPCYCLE_PATH'] = '/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type4'
    ...
    elif run_name == "no-upcycle-B-1e-4":
        global_args['USE_UPCYCLE'] = False
        global_args['NUM_EXPERTS'] = 32
        global_args['TOP_K'] = 8
        global_args['MOE_EXPANSION_FACTOR'] = 1
