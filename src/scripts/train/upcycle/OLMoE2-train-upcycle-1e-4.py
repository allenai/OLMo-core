...
if __name__ == "__main__":
    ...
    if run_name == "copy-mlp-1e-4":
        ...
        global_args[
            "UPCYCLE_PATH"
        ] = "/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type1"
        build_model_config_partial = partial(
            build_model_config,
            routed_expert_norm=False,
            shared_expert_norm=False,
        ...
        global_args[
            "UPCYCLE_PATH"
        ] = "/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type3"
        ...
        global_args[
            "UPCYCLE_PATH"
        ] = "/workspace/tmp/upcycled-OLMo-2-0425-1B/copy-mlp-as-shared-expert-type4"
