...
""".strip()
    ...
    config = LcContTrain.build(
        ...
        cmd="train",
        run_name=run_name,
        load_path="gs://ai2-llm/checkpoints/shanea/OLMo3-integrationtest-6/step79605/model_and_optim", #"gs://ai2-llm/checkpoints/OLMo3-7B-swafix/step289000/model_and_optim/",#
        cluster=cluster,
        overrides=overrides,
    )
