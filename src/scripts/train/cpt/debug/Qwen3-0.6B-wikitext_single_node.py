...
if __name__ == "__main__":
    ...
    Examples:
        Render the config and exit:
            python src/scripts/train/cpt/Qwen3-0.6B-wikitext_single_node.py dry_run my-run ai2/jupiter-cirrascale-2

        Launch on Beaker (single node):
            python src/scripts/train/cpt/Qwen3-0.6B-wikitext_single_node.py launch my-run ai2/jupiter-cirrascale-2
