...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            source_name="commonpile_ye_olde_books",
            target_ratio=0.5,
            paths=[
                f"s3://ai2-llm/preprocessed/common-pile_ye-ole-books/v0/common-pile_pre_1929_books_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_ye-ole-books/v0/common-pile_project_gutenberg_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
