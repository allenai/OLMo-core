...
DATASET_CONFIG = SourceMixtureList(
    sources=[
        ...
        SourceMixtureConfig(
            source_name="commonpile_texbookish",
            target_ratio=0.5,
            paths=[
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_biodiversity_heritage_library_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_libretexts_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_news_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_oercommons_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_pressbooks_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_public_domain_review_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
                f"s3://ai2-llm/preprocessed/common-pile_texbookish/v0/common-pile_youtube_filtered/{TOKENIZER_CONFIG.identifier}/*.npy",
            ],
        ),
    ]
)
