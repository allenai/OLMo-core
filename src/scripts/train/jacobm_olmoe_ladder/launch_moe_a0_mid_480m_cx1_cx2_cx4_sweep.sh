...
LOG_DIR="${LOG_DIR:-/tmp/olmoe3-moe-a0-mid-480m-cx1-cx2-cx4-launch-logs}"
...
launch_one() {
  ...
  local name="${RUN_PREFIX}-${cx}-${batch_tag}-${perf_tag}-${lr_tag}-${SWEEP_SUFFIX}"
  ...
  local cmd=(
    ...
    --tag="${lr_tag}-${RUN_PREFIX}-${cx}-${batch_tag}-${perf_tag}-${SWEEP_SUFFIX}"
  )
...
launch_one cx1 b256k 32 6e-4 lr6e-4
launch_one cx1 b256k 32 1.2e-3 lr1.2e-3
launch_one cx1 b256k 32 2.4e-3 lr2.4e-3

launch_one cx2 b512k 64 3e-4 lr3e-4
launch_one cx2 b512k 64 6e-4 lr6e-4
launch_one cx2 b512k 64 1.2e-3 lr1.2e-3

launch_one cx4 b512k 64 4e-4 lr4e-4
launch_one cx4 b512k 64 8e-4 lr8e-4
launch_one cx4 b512k 64 1.6e-3 lr1.6e-3
