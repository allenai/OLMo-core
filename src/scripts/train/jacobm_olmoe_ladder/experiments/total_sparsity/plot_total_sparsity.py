#!/usr/bin/env python
"""Plot total-sparsity U-curves from W&B history."""
...
EXPERIMENT_TAG = "exp_total_sparsity"
OUTPUT_SUBDIR = "total_sparsity"
...
def experiment_variant_name(name: str) -> str | None:
    if "sp24e4k" in name:
        return "low_total_24e_top4"
    if "sp96e4k" in name:
        return "high_total_96e_top4"
    if "sp192e4k" in name:
        return "huge_total_192e_top4"
    if "sp48e4k" in name:
        return "baseline_48e_top4_sparsity_tag"
    return None
