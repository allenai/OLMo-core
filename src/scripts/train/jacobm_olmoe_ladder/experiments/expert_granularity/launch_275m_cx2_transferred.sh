...
launch_one() {
  ...
  local cmd=(
    ...
    --tag="${eg_tag}-cx2-${lr_tag}-${SWEEP_SUFFIX}"
...
for spec in coarse_24e_top2:eg24e2k fine_96e_top8:eg96e8k; do
  ...
  launch_one "${expert_geometry}" "${eg_tag}" 5e-4 lr5e-4 "${micro_bsz}"
