...
and a kernel investigation. The canonical GDN2 (`expand_v=1`, nonnegative)
and canonical KDA 275M sweeps are now running in Cx-first submission order.
