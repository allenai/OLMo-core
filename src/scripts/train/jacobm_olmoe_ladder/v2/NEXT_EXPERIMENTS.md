...
while larger original-GDN2 trajectories still show numerical failures. The
canonical KDA sweep is complete; canonical GDN2 (`expand_v=1`, nonnegative)
has only two Cx8 cells remaining.
...
| 8 | LatentMoE | On promoted KDA, project only the routed expert branch to a smaller latent width. Start with 2× and paper-standard 4× compression; compare PR #799's latent-width routing, full-width-router fixed-expert controls, and the paper-matched recipe that multiplies both total experts and top-k by compression. | PR #799's full-width router fix is ported. The promoted 275M families are L=2 512/top-16 and L=4 1,000/top-32; all 16 Cx1/Cx2 cells finished with bracketed curves selecting observed LR `1.6e-3`. The eight Cx4 cells are submitted allocated and the eight Cx8 cells unallocated. Proposed 480M/810M/1.2B dimensions and parameter counts are recorded but their builders and capacity smokes remain pending. See [`LATENT_MOE.md`](LATENT_MOE.md). |
