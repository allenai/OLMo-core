...
from olmo_core.nn.moe.v2.checkpoint_conversion import convert_legacy_config
...
def load_wide_model_config(
    ...
    *,
    ...
    return OLMoDDPModelConfig.from_dict(convert_legacy_config(payload)["model"])
...
def build_hybrid_model_config(
    ...
    *,
    ...
    for layer_idx in swa_layers:
        ...
        attention_width = attention.d_attn or base.d_model
        head_dim = attention.head_dim or attention_width // attention.n_heads
