...
transfer, MXFP8, LatentMoE, validation, and V1 results were fully refreshed at
2026-08-01 18:49 UTC. Strict final-250M collection remains required; no partial
or reset-shortened summary was used.
...
| pretraining | LatentMoE L=2 scale promotion | 11 finished / 1 running | 480M and 810M are 4/4; 1.2B Cx1/Cx2/Cx4 are finished and Cx8 is running. Newly collected strict final-250M CEs are 810M Cx8 `2.074273` and 1.2B Cx4 `2.051686`. The 1.2B Cx1/Cx2/Cx4 workers ended in teardown SIGSEGVs only after reaching their complete token budgets; their strict final windows are intact. | [results](results/pretraining/kda_latent_moe/results.md) / [480M Cx4/Cx8](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYRZ44KSS6A9EJ10BKR5H5HE) / [810M](LATENT_MOE.md#proposed-larger-latentmoe-configs) / [1.2B](LATENT_MOE.md#810m-l4-control-and-12b-l2-promotion) |
