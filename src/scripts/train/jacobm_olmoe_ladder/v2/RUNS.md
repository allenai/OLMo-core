...
| pretraining | LatentMoE L=2 scale promotion | 480M Cx1/Cx2 and 810M Cx1 finished; eight running, 1.2B Cx8 queued | The new 810M Cx1 strict final-250M CE is `2.320513`, improving `0.031791` over matching KDA. The other live cells are healthy with zero skipped optimizer steps; L=2 uses 104 running GPUs and the queued 1.2B Cx8 requests 32. | [results](results/pretraining/kda_latent_moe/results.md) / [480M Cx4/Cx8](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYRZ44KSS6A9EJ10BKR5H5HE) / [810M](LATENT_MOE.md#proposed-larger-latentmoe-configs) / [1.2B](LATENT_MOE.md#810m-l4-control-and-12b-l2-promotion) |
