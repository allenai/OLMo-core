...
| pretraining | LatentMoE 275M LR sweeps | 20/32 finished; 12 running | L2 Cx4 is complete and bracketed, selecting `1.6e-3` with strict final-250M CE `2.443058`. L4 Cx4 and all eight Cx8 cells remain healthy/running. | [results](results/pretraining/kda_latent_moe/results.md) / [Cx4 work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYQS79P3JFX4SSB4AM7B8CDK) / [Cx8 work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYQS7J3NBH1TFX6Y1FGQ7WM2) |
| pretraining | LatentMoE L=2 480M promotion | Cx1 finished; Cx2 running | Cx1 finished cleanly with transferred LR `1.2e-3` and strict final-250M CE `2.463192`, improving `0.029091` over matching non-latent KDA Cx1. | [results](results/pretraining/kda_latent_moe/results.md) / [Cx1](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYQV7G4MX67GCYSFPMWEB1J8) / [Cx2](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYQYM4F8JFXHDX1RXQE7913R) |
