...
| pretraining | LatentMoE L=2 scale promotion | 12/12 finished | 480M, 810M, and 1.2B are all 4/4. The final 1.2B Cx8 cell has strict final-250M CE `1.985209`, versus `1.999736` for its non-latent KDA parent. The 1.2B workers reached their complete token budgets and have intact strict final windows despite post-training worker teardown failures. | [results](results/pretraining/kda_latent_moe/results.md) / [480M Cx4/Cx8](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYRZ44KSS6A9EJ10BKR5H5HE) / [810M](LATENT_MOE.md#proposed-larger-latentmoe-configs) / [1.2B](LATENT_MOE.md#810m-l4-control-and-12b-l2-promotion) |
