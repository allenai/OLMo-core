...
| qualification | LatentMoE PR #799, full-width-router controls, and paper-matched 275M configs | architecture and throughput qualification finished | Paper-matched 2×/4× are 295.664M/296.770M active params. Exact-2-Mi final-10 TPS/GPU is 255.5K for `L=1`, 214.7K for 2×, and 143.0K for 4× EP2 (286.0K aggregate). Usable large-batch maxima are MB15 for 2× and MB8 for 4×; 4× MB9 passes one microbatch but OOMs on the second accumulated microbatch. No full run or validation target launched. | [plan and results](LATENT_MOE.md) / [exact throughput](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP5SXH7ZK32FA8NM7AHXRV0) / [max-MB throughput](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP6RYG25M5VDSMDQ2S0ZRTR) |
