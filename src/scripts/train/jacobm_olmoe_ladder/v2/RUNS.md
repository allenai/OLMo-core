...
| qualification | LatentMoE PR #799, full-width-router controls, and paper-matched 275M configs | 4/4 fixed-expert tasks passed; 2 paper-matched tasks scheduled | Focused suite: 26 passed. Paper-matched 2× and 4× candidates use 512/top-16 and 1,024/top-32 experts and are audited at 295.664M and 296.770M active params. All three arms use independent pinned source trees; no full run or validation target launched. | [plan](LATENT_MOE.md) / [PR work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYNZRH7S8APE059CR042BTPC) / [full-router work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP02F6BRDCQSDR8JWDATAK8) / [paper-matched work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP0NWK5P0R9GQ22HS0P6BFH) |
