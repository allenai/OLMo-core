...
## Live status snapshot (2026-07-24 21:58 UTC)
...
| pretraining | 275M geometry + NoPE + gated attention + GDN2 | 15 finished / 1 deterministic failure + clean reproduction queued | Cx8 `1.6e-3` remains stopped at step 36,768; a distinct `-fresh-r2` trajectory starts at step 0 with fresh optimizer state | [results](results/pretraining/geometry_gdn2_ev2_nope_gated/results.md) |
| pretraining | larger geometry + NoPE + gated attention + GDN2 | 2 formal finished / 6 formal active / 4 deterministic failures + 4 clean reproductions queued | 810M Cx1/Cx2 and 1.2B Cx1/Cx2 now have distinct `-fresh-r2` step-0 trajectories; 1.2B Cx4/Cx8 varying-step retries and 480M/810M Cx4/Cx8 production runs continue | [results](results/pretraining/geometry_gdn2_ev2_nope_gated/results.md) |
...
also finished. The consolidated validation export now contains 115 finished
