...
| qualification | LatentMoE PR #799 and full-width-router 275M configs | two allocated two-task smoke arms active | Focused full-router suite: 26 passed; complete MoE/DDP/init files: 50 passed / 11 GPU skips. Full-router 2× and 4× candidates are audited at 248.294M and 223.503M active params. PR semantics are pinned to `7490a4a5a`; full-router semantics are pinned to `cd33510eb`; no full run or validation target launched. | [plan](LATENT_MOE.md) / [PR work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYNZRH7S8APE059CR042BTPC) / [full-router work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP02F6BRDCQSDR8JWDATAK8) |
