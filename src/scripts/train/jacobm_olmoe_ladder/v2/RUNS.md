...
transfer, MXFP8, and LatentMoE rows were refreshed at 2026-07-29 06:58 UTC.
...
| pretraining | KDA `expand_v=2`, negative-eigenvalue transfer (275M/480M/810M/1.2B) | 14 finished / 2 running | 810M is now 4/4; 1.2B Cx1/Cx2 finished at strict final-250M CE `2.236574`/`2.146299`, while Cx4/Cx8 remain active. No failures in this KDA family. | [results](results/pretraining/canonical_gdn2_kda/kda_ev2_neg_scale_results.md) / [launches](#kda-expand_v2-negative-eigenvalue-transfer) |
| qualification | LatentMoE PR #799, full-width-router controls, and 275M parameter-matched configs | 1,000-expert EP1 replacement qualification in progress | Paper-matched 2× and exact 4× are 295.664M/296.770M active params. The selected 4× EP1 approximation uses exactly 1,000 experts/top-32 and is 296.632M active / 3.073B stored. MB8 passed; MB9--11 and the formal 50-step TPS measurement are queued. The original 1,024-expert L4 production tasks were canceled before training. | [plan and results](LATENT_MOE.md) / [capacity](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP96YAGZ4CZCZBT87NHSA5X) / [MB9](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYPARNB9QDWBGV5HE3PKDK76) |
| pretraining | LatentMoE 275M Cx1/Cx2 LR sweep | L2 8 running; L4 replacement pending qualification | L2 uses 512/top-16 on EP1. The canceled 1,024-expert L4 arm will be replaced by the 1,000/top-32 EP1 config after its capacity/TPS checks pass; both use the four-LR `4e-4`--`3.2e-3` sweep. | [results](results/pretraining/kda_latent_moe/results.md) / [L2 work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYP8XVJJ0PTT6KHY4PNZV861) |
...
The winner-only validation wave is capacity-deferred. At the last audit, 48
checkpoints were ready and five additional KDA winners were still training.
Before launching, refresh that inventory and de-duplicate it against the 117
historical completed targets. Keep the new policy at EP1 with LM validation and
the `fast` downstream suite; do not register LatentMoE until a full run has an
LR winner.
