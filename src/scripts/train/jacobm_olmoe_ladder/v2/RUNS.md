...
| pretraining | LatentMoE L=2 scale promotion | 480M Cx1/Cx2 finished; 480M Cx4/Cx8 and all 810M running; all 1.2B submitted | 480M Cx1/Cx2 strict final-250M CEs are `2.463192`/`2.361694`, improving `0.029091`/`0.021001` over matching KDA. The balanced 1.2B Cx1/2/4/8 wave requests 8/16/16/32 GPUs. | [results](results/pretraining/kda_latent_moe/results.md) / [480M Cx4/Cx8](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYRZ44KSS6A9EJ10BKR5H5HE) / [810M](LATENT_MOE.md#proposed-larger-latentmoe-configs) / [1.2B](LATENT_MOE.md#810m-l4-control-and-12b-l2-promotion) |
| pretraining | LatentMoE L=4 1,000e 810M Cx4 control | submitted | YOLO transferred-LR control: 16 GPUs, EP1, MB4, LR `4e-4`; exact guarded size is 857.246M active / 11.598B stored. | [work](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYSWABKPZ9DAVYW2RGH70CAZ) |
