...
| qualification | LatentMoE PR #799 + 275M configs | local audit complete; GPU smokes pending | Focused implementation suite: 25 passed / 4 distributed-GPU skips. KDA-parent 2× and 4× routed-compression configs are audited at 247.557M and 222.397M active params; no full run or validation target launched. | [plan](LATENT_MOE.md) |
