...
| pretraining | LatentMoE L=2 scale promotion | 480M Cx1/Cx2 and 810M Cx1/Cx2 finished; seven running, 1.2B Cx8 queued | The 810M Cx1/Cx2 strict final-250M CEs are `2.320513`/`2.223199`, improving `0.031791`/`0.018674` over matching KDA. All live cells continue advancing; four live cells and the finished 810M Cx2 have logged intermittent guarded optimizer-step skips. L=2 uses 88 running GPUs and the queued 1.2B Cx8 requests 32. | [results](results/pretraining/kda_latent_moe/results.md) / [480M Cx4/Cx8](https://beaker.org/orgs/ai2/workspaces/OLMo-3-moe-experiments/work/01KYRZ44KSS6A9EJ10BKR5H5HE) / [810M](LATENT_MOE.md#proposed-larger-latentmoe-configs) / [1.2B](LATENT_MOE.md#810m-l4-control-and-12b-l2-promotion) |
...
At the 2026-07-30 21:24 UTC audit, seven L=2 LatentMoE cells and the 810M L=4
control are running on 104 Holmes B300s. The 1.2B L=2 Cx8 cell is
scheduled but waiting for its four synchronized eight-GPU replicas. The
finished 810M L=2 Cx1/Cx2 cells have now been collected; no validation or legacy V1
job is live.
