...
DEFAULT_EXPERIMENTS = [
    ...
    "01KXE4EEA2AW00JT58FVSJ6QTP",  # 275M top16 integration midtrained OLMoBase
    "01KXE4EQ00WWMKW3EZ2DZ91PPH",  # 275M top16 integration midtrained OLMoBase with eval topK=8
]
CACHE_VERSION = 1
HIGH_LEVEL_SUITES = [
...
def display_intervention(name: str) -> str:
    labels = (
        ...
        ("baseline", "baseline"),
        ("mt-int-wide-top16-top8", "integration top16 eval top8"),
        ("mt-int-wide-top16", "integration top16"),
        ("mt-int-wide", "integration 1 wide"),
        ("mt-int-deep", "integration 1 deep"),
