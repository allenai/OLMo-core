...
| 480M integration wide Cx8 | `integration/int-480m-cx8-intw256e8k-lr8e-4-r1/step78042` | `8e-5` | run | [relaunch](https://beaker.org/ex/01KX6K2NTZZRVE98HCQWE2DR64) | Initial promoted Cx8 MT failed during checkpoint save under Weka space pressure; relaunched with same semantic name/save folder to resume from partial checkpoint. |
| 810M integration wide Cx8 | `integration/int-810m-cx8-intw256e8k-lr4e-4-r1/step141423` | `4e-5` | run | [relaunch](https://beaker.org/ex/01KX6K330J3Z5CSDY518BGJ05B) | Initial promoted Cx8 MT failed during checkpoint save under Weka space pressure; relaunched with same semantic name/save folder to resume from partial checkpoint. |
| 1.2B integration wide Cx8 | `integration/int-1p2b-cx8-intw256e8k-lr4e-4-r2/step217870` | `4e-5` | run | [relaunch](https://beaker.org/ex/01KX6K3KB852TCJYC4KVBXVXVP) | Initial promoted Cx8 MT failed during checkpoint save under Weka space pressure; relaunched with same semantic name/save folder. |
...
| 810M integration deep Cx8 | `integration/int-810m-cx8-intd256e8k-lr4e-4-r1/step138619` | `4e-5` | queued | [relaunch](https://beaker.org/ex/01KX6K4GKDHQS05727Q9DH0NF4) | Initial promoted Cx8 MT failed during checkpoint save under Weka space pressure; relaunched with same semantic name/save folder to resume from partial checkpoint. |
| 1.2B integration deep Cx8 | `integration/int-1p2b-cx8-intd256e8k-lr4e-4-r2/step218156` | `4e-5` | queued | [relaunch](https://beaker.org/ex/01KX6K4YBN8659G8SY8A4WAQA4) | 1.2B deep Cx8 pretraining finished; first MT attempt was manually stopped during storage triage, then relaunched with the full promoted wave. |
...
| 275M integration deep Cx1 | `2e-4` | [01KX5CM5NCAGRQ97Z51CSCVXR3](https://beaker.org/ex/01KX5CM5NCAGRQ97Z51CSCVXR3) | created | Launched 2026-07-10 in the MoE workspace; copy after it finishes. |
| 275M integration deep Cx2 | `1.8e-4` | [01KX5CMGM8BKX6JYHXWQ3A1CXJ](https://beaker.org/ex/01KX5CMGM8BKX6JYHXWQ3A1CXJ) | created | Launched 2026-07-10 in the MoE workspace; copy after it finishes. |
| 275M integration deep Cx4 | `1.5e-4` | [01KX5CMWZR8PJSJEG56DCB9455](https://beaker.org/ex/01KX5CMWZR8PJSJEG56DCB9455) | created | Launched 2026-07-10 in the MoE workspace; copy after it finishes. |
| 275M integration deep Cx8 | `1.6e-4` | [01KX5CN86SGER9E88YASSS7J06](https://beaker.org/ex/01KX5CN86SGER9E88YASSS7J06) | created | Launched 2026-07-10 in the MoE workspace; copy after it finishes. |
| 1.2B baseline Cx1 | `4e-5` | [01KX5CNTTRBMEXBA1XJ1JNM0ZR](https://beaker.org/ex/01KX5CNTTRBMEXBA1XJ1JNM0ZR) | created | Launched 2026-07-10 in the MoE workspace; copy after it finishes. |
