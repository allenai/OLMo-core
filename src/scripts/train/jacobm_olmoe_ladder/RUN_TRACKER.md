...
| `mt-1p2b-intw256e8k-cx8-lr4e-5-r1/step127157` | [01KXE0C5662V06ANB4JW7DTE1E](https://beaker.org/ex/01KXE0C5662V06ANB4JW7DTE1E) | [01KXE4E4JD4QJER5KEQX2EJF6E](https://beaker.org/ex/01KXE4E4JD4QJER5KEQX2EJF6E) | eval launched | HF conversion finalized 2026-07-13. OLMoBase launched in the MoE workspace on Jupiter with 8 vLLM instances from `eval_20260713_olmobase_targets.jsonl`. |
...
| `mt-275m-intw256e16k-cx4-lr8e-5-r1/step95368` | [01KXE0C6BFQFWVJKCDWK7300J5](https://beaker.org/ex/01KXE0C6BFQFWVJKCDWK7300J5) | [01KXE8ZQTDBCC2QRX8YXDWHAS9](https://beaker.org/ex/01KXE8ZQTDBCC2QRX8YXDWHAS9) | eval launched | Default topK=16 OLMoBase relaunched in the MoE workspace on Jupiter with 8 vLLM instances; previous `ai2/olmo-instruct` attempt was stopped before running. |
| `mt-275m-intw256e16k-cx4-lr8e-5-r1/step95368-topk8` | local HF config copy | [01KXE900EMBX7MDDFQEWMMN69J](https://beaker.org/ex/01KXE900EMBX7MDDFQEWMMN69J) | eval launched | Hardlinked HF copy with `num_experts_per_tok=8` and `original_num_experts_per_tok=16`; OLMoBase relaunched in the MoE workspace on Jupiter with 8 vLLM instances. Previous `ai2/olmo-instruct` attempt was stopped before running. |
