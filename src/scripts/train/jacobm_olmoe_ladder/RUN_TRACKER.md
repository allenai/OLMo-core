...
| 1.2B integration wide Cx8 | `integration/int-1p2b-cx8-intw256e8k-lr4e-4-r2/step217870` | `4e-5` | failed | [relaunch](https://beaker.org/ex/01KX6K3KB852TCJYC4KVBXVXVP) | Relaunch failed during checkpoint restore/model-buffer sync with CUDA OOM: tried to allocate 36.61 GiB with 32.35 GiB free on B200. Needs lower-memory settings before retry. |
...
| 1.2B integration deep Cx8 | `integration/int-1p2b-cx8-intd256e8k-lr4e-4-r2/step218156` | `4e-5` | failed | [relaunch](https://beaker.org/ex/01KX6K4YBN8659G8SY8A4WAQA4) | Relaunch reached compiled forward then OOMed with GPU nearly full. Needs lower-memory settings before retry, likely matching the pretraining EP8-style configuration rather than EP1/MB4. |
