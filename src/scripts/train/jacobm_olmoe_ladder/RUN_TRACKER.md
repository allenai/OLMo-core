...
| 1.2B integration deep Cx8 | `integration/int-1p2b-cx8-intd256e8k-lr4e-4-r2/step218156` | `4e-5` | queued | [PT-settings relaunch](https://beaker.org/ex/01KX703FE8T96HJM4EFG90KHVF) | Previous EP1/MB4 relaunch reached compiled forward then OOMed. Retried with the exact successful PT systems settings: GBS seq 96, 1 node x 8 GPUs, EP8 / MB3. |
