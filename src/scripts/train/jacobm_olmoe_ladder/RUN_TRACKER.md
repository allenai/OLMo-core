...
| `mt-480m-intd256e8k-cx8-lr8e-5-r1/step63579` | [01KXBF94GH2KDH2ZAJYT2E8ZF7](https://beaker.org/ex/01KXBF94GH2KDH2ZAJYT2E8ZF7) | [01KXBPB8V0724FNM2RK46GVTPD](https://beaker.org/ex/01KXBPB8V0724FNM2RK46GVTPD) | eval launched | HF conversion finalized 2026-07-12. OLMoBase launched in `ai2/olmo-instruct` on Jupiter with 8 vLLM instances from `eval_integration_deep_mt_cx8_targets.jsonl`. |
| `mt-810m-intd256e8k-cx8-lr4e-5-r1/step47684` | [01KXBF95SYXE13VVMHEXJWNS4H](https://beaker.org/ex/01KXBF95SYXE13VVMHEXJWNS4H) | [01KXBPBHYMFHPNZ2KAC6WE2J5X](https://beaker.org/ex/01KXBPBHYMFHPNZ2KAC6WE2J5X) | eval launched | HF conversion finalized 2026-07-12. OLMoBase launched in the MoE workspace on Jupiter with 8 vLLM instances from `eval_integration_deep_mt_cx8_targets.jsonl`. |
...
| `mt-275m-intw256e16k-cx4-lr8e-5-r1` | started | launched 2026-07-12 | https://beaker.org/ex/01KXBH2HBN9W4M46H33CRGHVJS | Midtraining follow-up for the high-active wide diagnostic final checkpoint `integration/int-275m-cx4-intw256e16k-lr8e-4-r1/step61993`. Uses `wide_256e16k`, LR `8e-5`, 100B MT tokens, 1 node x 8 GPUs, GBS seq 128, EP1 / MB4, compile-on, fresh optimizer / weight-only load. At last check it was counting source tokens; W&B had not registered the run yet. |
