...
| `mt-275m-intw256e16k-cx4-lr8e-5-r1/step95368` | [01KXE0C6BFQFWVJKCDWK7300J5](https://beaker.org/ex/01KXE0C6BFQFWVJKCDWK7300J5) | [01KXE4EEA2AW00JT58FVSJ6QTP](https://beaker.org/ex/01KXE4EEA2AW00JT58FVSJ6QTP) | eval launched | Default topK=16 OLMoBase launched in `ai2/olmo-instruct` on Jupiter with 8 vLLM instances. |
| `mt-275m-intw256e16k-cx4-lr8e-5-r1/step95368-topk8` | local HF config copy | [01KXE4EQ00WWMKW3EZ2DZ91PPH](https://beaker.org/ex/01KXE4EQ00WWMKW3EZ2DZ91PPH) | eval launched | Hardlinked HF copy with `num_experts_per_tok=8` and `original_num_experts_per_tok=16`; OLMoBase launched in `ai2/olmo-instruct` on Jupiter with 8 vLLM instances. |
