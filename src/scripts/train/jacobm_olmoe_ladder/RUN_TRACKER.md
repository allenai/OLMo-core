...
| `mt-275m-intw256e16k-cx4-lr8e-5-r1` | started | launched 2026-07-12 | https://beaker.org/ex/01KXBH2HBN9W4M46H33CRGHVJS | Midtraining follow-up for the high-active wide diagnostic final checkpoint `integration/int-275m-cx4-intw256e16k-lr8e-4-r1/step61993`. Uses `wide_256e16k`, LR `8e-5`, 100B MT tokens, 1 node x 8 GPUs, GBS seq 128, EP1 / MB4, compile-on, fresh optimizer / weight-only load. W&B `kmxhtpxp`; at 2026-07-13 06:42 UTC it had logged 88.18B / 100B tokens and was still running. |
