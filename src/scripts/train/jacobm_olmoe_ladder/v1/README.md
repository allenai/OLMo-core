...
> Historical DDP-migration snapshot (2026-07-14). These launchers target the
> legacy trainer and are reference-only. See `../README.md` and `MIGRATION.md`
> before using anything operationally.
