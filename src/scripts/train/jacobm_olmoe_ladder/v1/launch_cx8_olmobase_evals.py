#!/usr/bin/env python3
"""Launch Cx8 OLMoBase evals for the current MoE eval batch."""
...
MANIFEST = Path(__file__).with_name("eval_cx8_eval_batch_targets.jsonl")
GROUP_OLMO_INSTRUCT = "olmoe3-cx8-olmobase"
GROUP_NORMAL = "olmoe3-cx8-olmobase-main"
BUDGET = "ai2/oe-other"
...
def launch_command(target: dict, *, dry_run: bool) -> list[str]:
    ...
    name = f"olmoe3-{size}-cx8-{slug}-olmobase"
    workspace = (
        "ai2/olmo-instruct"
