#!/usr/bin/env python
"""Plot integration-candidate U-curves from W&B history."""
...
EXPERIMENT_TAG = "exp_integration"
OUTPUT_SUBDIR = "integration"
PLOT_TITLE = "Integration candidates"
VARIANT_LABELS = {
...
VARIANT_ORDER = [
    ...
    "integration_wide_256e8k",
    "integration_deep_256e8k",
]
SUMMARY_VARIANTS = [
    SummaryVariant(
        "baseline",
    ...
    SummaryVariant("integration_wide_256e8k", ("integration_wide_256e8k",), "integration wide 256E/top8"),
    SummaryVariant("integration_deep_256e8k", ("integration_deep_256e8k",), "integration deep 256E/top8"),
]
...
def model_from_name(name: str) -> str | None:
    integration_match = re.search(r"int-(275m|480m|810m|1p2b)-cx", name)
    if integration_match:
        return integration_match.group(1)
...
def experiment_variant_name(name: str) -> str | None:
    if "intw256e8k" in name:
        return "integration_wide_256e8k"
    if "intd256e8k" in name:
        return "integration_deep_256e8k"
    return None
        ...
        api.runs(
            ...
            filters={
                "$or": [
                    ...
                    {"display_name": {"$regex": "int-(275m|480m|810m|1p2b)-cx(1|2|4|8)-int[wd]256e8k"}},
...
def main() -> None:
    ...
    plot_observed_best_summary(
        ...
        title="Integration candidates observed best",
