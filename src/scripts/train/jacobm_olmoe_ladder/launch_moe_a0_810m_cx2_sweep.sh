...
RUN_PREFIX="olmoe3-moe-a0-810m-cx2"
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-/weka/oe-training-default/ai2-llm/checkpoints/jacobm/olmoe3}"
LOG_DIR="${LOG_DIR:-/tmp/olmoe3-moe-a0-810m-cx2-sweep-launch-logs}"
...
CHINCHILLA_MULTIPLE="${CHINCHILLA_MULTIPLE:-2}"
...
launch_one() {
  ...
  local cmd=(
    ...
    --tag="${lr_tag}-810m-cx2-b512k-${perf_tag}-${SWEEP_SUFFIX}"
  )
...
launch_one 1.5e-4 lr1.5e-4
launch_one 3e-4 lr3e-4
launch_one 6e-4 lr6e-4
