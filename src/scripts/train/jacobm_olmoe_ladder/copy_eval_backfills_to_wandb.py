...
BACKFILLS = [
    ...
    BackfillSpec("mt-eval-275m-baseline-cx2-lr1p8e-4-r1", "mt-275m-baseline-cx2-lr1p8e-4-r1"),
    BackfillSpec("mt-eval-275m-baseline-cx4-lr1p5e-4-r1", "mt-275m-baseline-cx4-lr1p5e-4-r1"),
    BackfillSpec("mt-eval-480m-baseline-cx1-lr1p2e-4-r1", "mt-480m-baseline-cx1-lr1p2e-4-r1"),
    BackfillSpec("mt-eval-480m-baseline-cx8-lr8e-5-r1", "mt-480m-baseline-cx8-lr8e-5-r1"),
    BackfillSpec("mt-eval-810m-baseline-cx1-lr6e-5-r1", "mt-810m-baseline-cx1-lr6e-5-r1"),
    BackfillSpec("mt-eval-810m-baseline-cx8-lr4e-5-r1", "mt-810m-baseline-cx8-lr4e-5-r1"),
    BackfillSpec("mt-eval-1p2b-baseline-cx1-lr4e-5-r1", "mt-1p2b-baseline-cx1-lr4e-5-r1"),
    BackfillSpec("mt-eval-1p2b-baseline-cx8-lr4e-5-r1", "mt-1p2b-baseline-cx8-lr4e-5-r1"),
    BackfillSpec("mt-eval-275m-intw256e8k-cx1-lr2e-4-r3", "mt-275m-intw256e8k-cx1-lr2e-4-r3"),
    BackfillSpec("mt-eval-275m-intw256e8k-cx2-lr1p8e-4-r3", "mt-275m-intw256e8k-cx2-lr1p8e-4-r3"),
    BackfillSpec("mt-eval-275m-intw256e8k-cx4-lr1p5e-4-r3", "mt-275m-intw256e8k-cx4-lr1p5e-4-r3"),
    BackfillSpec("mt-eval-275m-intw256e8k-cx8-lr1p6e-4-r3", "mt-275m-intw256e8k-cx8-lr1p6e-4-r3"),
    BackfillSpec("mt-eval-275m-intd256e8k-cx1-lr2e-4-r3", "mt-275m-intd256e8k-cx1-lr2e-4-r3"),
    BackfillSpec("mt-eval-275m-intd256e8k-cx2-lr1p8e-4-r3", "mt-275m-intd256e8k-cx2-lr1p8e-4-r3"),
    BackfillSpec("mt-eval-275m-intd256e8k-cx4-lr1p5e-4-r3", "mt-275m-intd256e8k-cx4-lr1p5e-4-r3"),
    BackfillSpec("mt-eval-275m-intd256e8k-cx8-lr1p6e-4-r3", "mt-275m-intd256e8k-cx8-lr1p6e-4-r3"),
    BackfillSpec("mt-eval-480m-intw256e8k-cx8-lr8e-5-r1", "mt-480m-intw256e8k-cx8-lr8e-5-r1"),
    BackfillSpec("mt-eval-480m-intd256e8k-cx8-lr8e-5-r1", "mt-480m-intd256e8k-cx8-lr8e-5-r1"),
