...
| 2026-06-05 | `olmoe3-tiny-cx1-ep8drop-lr1e-3` | `tiny_275m.py` | 1x | 262,144 | 32 | 1e-3 | `01KTB86J84BNDZJYXWMPVC9FVG` | https://beaker.org/ex/01KTB86J84BNDZJYXWMPVC9FVG | Replacement dropless EP sanity check with a shorter W&B group name. 8 GPUs, EP=8, microbatch=4, `--no-use-rowwise-a2a`. Reached real training past step 1400 with skipped steps 0 and token drop rate 0.0. Exclude from ladder LR fits and canonical plots. |
...
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr1.6e-3-pilot` | `tiny_275m.py` | 1x | 262,144 | 32 | 1.6e-3 | `01KTAPFMM1YG2TE3RJX9B94CH1` | https://beaker.org/ex/01KTAPFMM1YG2TE3RJX9B94CH1 | Exploratory 810M Cx1 pilot at the current transferred-LR estimate. Uses the validated 4-GPU, EP=1, microbatch=4 setting. May be ignored when choosing the final 810M sweep once the 275M Cx8/Cx16 LR rule is fully bracketed. |
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr6e-4-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 6e-4 | `01KTB9D4971X2ZEXK61W1WJ23H` | https://beaker.org/ex/01KTB9D4971X2ZEXK61W1WJ23H | First 810M Cx1 LR sweep, cold-side anchor. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_sweep.sh`. |
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr1.2e-3-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 1.2e-3 | `01KTB9DGWWHW2C5HJAYC40AZPX` | https://beaker.org/ex/01KTB9DGWWHW2C5HJAYC40AZPX | First 810M Cx1 LR sweep, below transferred estimate. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_sweep.sh`. |
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr2.4e-3-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 2.4e-3 | `01KTB9DWX644NVSVP6Y6B6N7J7` | https://beaker.org/ex/01KTB9DWX644NVSVP6Y6B6N7J7 | First 810M Cx1 LR sweep, above transferred estimate. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_sweep.sh`. |
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr6e-3-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 6e-3 | `01KTB9E8MXS8TWGFS1F65HJJMD` | https://beaker.org/ex/01KTB9E8MXS8TWGFS1F65HJJMD | First 810M Cx1 LR sweep, hot-side sentinel. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_sweep.sh`. |
