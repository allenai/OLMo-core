...
| 2026-06-07 | `olmoe3-moe-a0-810m-cx2-b512k-gpu8-ep1mb4-lr1.5e-4-r1` | `tiny_275m.py` | 2x | 524,288 | 64 | 1.5e-4 | `01KTHW7HB59AMPSZBP8FJHS5QG` | https://beaker.org/ex/01KTHW7HB59AMPSZBP8FJHS5QG | Paused intentionally on 2026-06-08 to free 8 GPUs for another user's urgent job. Resumed/requeued on 2026-06-08 with fresh job `01KTMJHQVXKD9FXCT3YTNQPVYJ`. 8 GPUs, EP=1, microbatch=4, in-loop fast evals every 2000 steps. |
