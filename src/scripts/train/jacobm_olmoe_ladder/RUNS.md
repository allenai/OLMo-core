...
| 2026-06-05 | `olmoe3-tiny-275m-cx1-b256k-gpu8-ep8mb4-lr1e-3-dropless-sanity` | `tiny_275m.py` | 1x | 262,144 | 32 | 1e-3 | `01KTAPHEJMG8DV9ZB4RHTRHMCV` | https://beaker.org/ex/01KTAPHEJMG8DV9ZB4RHTRHMCV | Diagnostic-only follow-up to the EP=8 sanity check. Uses the same EP=8, 8-GPU, microbatch=4 setting but launches with `--no-use-rowwise-a2a` for the slower dropless EP path. Exclude from ladder LR fits and canonical plots. |
