...
| 2026-06-09 | `m480-cx2-b512k-gpu4-ep1mb8-lr9.6e-3-r1` | `tiny_275m.py` | 2x | 524,288 | 64 | 9.6e-3 | `01KTQ3V5C3BJNDXHD38BV76KTH` | https://beaker.org/ex/01KTQ3V5C3BJNDXHD38BV76KTH | Midpoint `mid_480m` Cx2 far hot-side sentinel to quickly find the right-side turnover after the initial triplet was monotonic. Launched from `launch_moe_a0_mid_480m_cx2_followups.sh`. 4 GPUs, EP=1, microbatch=8, in-loop fast evals every 2000 steps. |
