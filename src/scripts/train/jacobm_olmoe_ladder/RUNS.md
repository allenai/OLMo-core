...
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr5e-5-cold-sentinel-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 5e-5 | `01KTCBQ1RGPG86GR8KKBYN6DT1` | https://beaker.org/ex/01KTCBQ1RGPG86GR8KKBYN6DT1 | Far cold-side sentinel to ensure the 810M Cx1 cold side brackets. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_cold_sentinel.sh`. |
