...
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr3e-4-cold-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 3e-4 | `01KTCBDVG2FJCPTFVR16G6X0TE` | https://beaker.org/ex/01KTCBDVG2FJCPTFVR16G6X0TE | Cold-side extension because the first 810M Cx1 sweep was low-edge best at `6e-4`. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_cold_ext.sh`. |
| 2026-06-05 | `olmoe3-moe-a0-810m-cx1-b256k-gpu4-ep1mb4-lr1.5e-4-cold-r1` | `tiny_275m.py` | 1x | 262,144 | 32 | 1.5e-4 | `01KTCBE8QQ4S23W3DCBDNGWNQS` | https://beaker.org/ex/01KTCBE8QQ4S23W3DCBDNGWNQS | Cold-side extension because the first 810M Cx1 sweep was low-edge best at `6e-4`. 4 GPUs, EP=1, microbatch=4, final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_cold_ext.sh`. |
...
| 2026-06-05 | `olmoe3-810m-cx1-b256k-gpu8-ep1mb4-lr5e-5-cs-r2` | `tiny_275m.py` | 1x | 262,144 | 32 | 5e-5 | `01KTCD57W068CSD9F72HFAQ21N` | https://beaker.org/ex/01KTCD57W068CSD9F72HFAQ21N | Short-name relaunch of the far cold-side sentinel. 8 GPUs, EP=1, microbatch=4, same global batch as the 4-GPU Cx1 runs; final-only permanent checkpoint plus ephemeral resume checkpoints. Created from launcher `launch_moe_a0_810m_cx1_cold_sentinel.sh`. |
| 2026-06-05 | `olmoe3-eval-275m-cx1-lr1e-3-r2` | `tiny_275m.py` | eval-only | n/a | n/a | n/a | `01KTD0JFDAE3CXYKZV85CYVRYC` | https://beaker.org/ex/01KTD0JFDAE3CXYKZV85CYVRYC | Eval backfill smoke over checkpoint `/weka/oe-training-default/ai2-llm/checkpoints/jacobm/olmoe3/olmoe3-tiny-275m-cx1-b256k-gpu2-ep1mb16-lr1e-3-r2/step15365`. Uses scaling-ladders-style fast downstream evals plus v3-small PPL validation. Created from launcher `launch_moe_a0_eval_backfill_smoke.sh`; ignore for LR U-plots. |
| 2026-06-05 | `olmoe3-275m-cx1-evaltest-lr1e-3` | `tiny_275m.py` | 1x | 262,144 | 32 | 1e-3 | `01KTD0K416CRVYAN5CN5SQPK5Y` | https://beaker.org/ex/01KTD0K416CRVYAN5CN5SQPK5Y | 275M Cx1 ladder-eval training test. 2 GPUs, EP=1, microbatch=16, `--ladder-evals --eval-task-set=fast --eval-interval=100` to exercise in-loop eval quickly. Ignore for canonical LR-selection unless we explicitly promote it. |
