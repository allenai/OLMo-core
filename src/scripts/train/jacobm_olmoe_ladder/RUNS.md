...
| 2026-06-10 | `olmoe3-moe-a0-1p2b-cx8-b768k-gpu32-ep1mb1-lr4e-4-r1` | `tiny_275m.py` | 8x | 786,432 | 96 | 4e-4 | `01KTQZ0Q834TV6CCW5FZGKG12G` | https://beaker.org/ex/01KTQZ0Q834TV6CCW5FZGKG12G | 1.2B Cx8 3-point sweep centered from the validated 1.2B Cx4 transfer result. Kept running as the 4-node systems comparison point after the 4-node jobs showed only about 300 TFLOPs/GPU. W&B `gbt7khqj`, skipped steps 0 at ~6.29B tokens. 4 nodes x 8 GPUs, EP=1, microbatch=1, in-loop fast evals every 2000 steps. |
...
| `olmoe3-moe-a0-810m-cx2-b384k-gpu8-ep1mb2-lr2.8e-4-r2` | `810m` | 2.8e-4 | 393,216 | 48 | 8 | 1 | 2 | https://beaker.org/ex/01KTXRMPNEYF37JVNREN6WZV5K | Retry of failed `r1` startup attempt; queued/created on 2026-06-12. |
| `olmoe3-moe-a0-810m-cx2-b384k-gpu8-ep1mb2-lr5.6e-4-r2` | `810m` | 5.6e-4 | 393,216 | 48 | 8 | 1 | 2 | https://beaker.org/ex/01KTXRN76Y3J0TXX9HZN7YNMQX | Retry of failed `r1` startup attempt; queued/created on 2026-06-12. |
| `olmoe3-moe-a0-810m-cx2-b384k-gpu8-ep1mb2-lr1.12e-3-r2` | `810m` | 1.12e-3 | 393,216 | 48 | 8 | 1 | 2 | https://beaker.org/ex/01KTXRNNPV1134T95XAKC2HJWE | Retry of failed `r1` startup attempt; queued/created on 2026-06-12. |
