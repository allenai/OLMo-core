...
| 2026-06-09 | `m480-cx2-b512k-gpu4-ep1mb8-lr2.4e-3-r1` | `tiny_275m.py` | 2x | 524,288 | 64 | 2.4e-3 | `01KTPWRQD0Z7SN3KEA6EBMTCB2` | https://beaker.org/ex/01KTPWRQD0Z7SN3KEA6EBMTCB2 | Midpoint `mid_480m` Cx2 high-side extension after the initial Cx2 triplet was monotonic and high-edge-best at `1.2e-3`. Launched from `launch_moe_a0_mid_480m_cx2_followups.sh`. 4 GPUs, EP=1, microbatch=8, in-loop fast evals every 2000 steps. |
