...
# Reproducibility record for the tiny 275M-active MoE Cx1 LR sweep.
#
# Run from the repository root.
# By default this prints the commands without launching jobs:
#
#   src/scripts/train/jacobm_olmoe_ladder/reproduce_tiny_275m_lr_sweep_cx1.sh
#
# To actually launch the sweep again:
#
#   DRY_RUN=0 src/scripts/train/jacobm_olmoe_ladder/reproduce_tiny_275m_lr_sweep_cx1.sh
