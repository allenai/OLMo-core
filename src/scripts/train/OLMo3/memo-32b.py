...
def build_experiment_config(cli_context: CliContext) -> ExperimentConfig:
    ...
    trainer_config = cookbook.configure_trainer(
        ...
        load_path="/weka/oe-training-default/ai2-llm/checkpoints/stego32-highlr-filter3/step656000",
...
if __name__ == "__main__":
    ...
    Examples:
        ...
        To launch a training run on Augusta w/ 16 nodes:
        python src/scripts/train/OLMo3/memo-32b.py launch memo-32b ai2/augusta \
            --launch.num_nodes=16 \
