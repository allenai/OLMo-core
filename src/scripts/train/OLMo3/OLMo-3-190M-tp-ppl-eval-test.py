"""
Short verification run: 190M model with TP=2, PPL evals only.

Trains for 20 steps with an LM eval at step 10 to verify that perplexity evals
work with tensor parallelism enabled.

Usage:
    # Dry run (renders config and exits):
    python src/scripts/train/OLMo3/OLMo-3-190M-tp-ppl-eval-test.py dry_run test-tp-ppl ai2/jupiter

    # Launch on Beaker:
    python src/scripts/train/OLMo3/OLMo-3-190M-tp-ppl-eval-test.py launch test-tp-ppl ai2/jupiter
"""
