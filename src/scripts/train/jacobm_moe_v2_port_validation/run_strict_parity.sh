...
CANDIDATE_REPO=${CANDIDATE_REPO:-/weka/oe-adapt-default/jacobm/olmoe3/olmo-ddp-migration/OLMo-core-moe-v2-core}
...
ARTIFACT_ROOT=${ARTIFACT_ROOT:-/weka/oe-training-default/ai2-llm/checkpoints/jacobm/olmoe3/olmo-ddp/port-validation/f5376c184/parity/275m-cx1-step16108}
