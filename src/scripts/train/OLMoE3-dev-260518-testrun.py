...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    config = (
        TrainerConfig(
            ...
            load_path="/workspace/checkpoint/OLMoE3-dev-260518-testrun0-nopp-noep-bf16-norecompute_2048d3072a_8L2048M2048S_32E4K1S_testrun0-nopp-noep-bf16-norecompute/step0",
            save_overwrite=True,
        ...
        .with_callback(
            "profiler",
            NvidiaProfilerCallback(
                enabled=USE_NV_PROFILE, profile_ranks=list(range(0, 8 * 8, 8)), start=5031, end=5035
            ),
        )
        .with_callback(
            "torch_mem_history",
