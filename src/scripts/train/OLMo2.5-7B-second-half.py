...
from olmo_core.optim import CosWithWarmup, OptimGroupOverride, SkipStepAdamWConfig, HalfCosWithWarmup, SchedulerUnits
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            hard_stop=Duration.tokens(int(6e12)),
        )
        .with_callback(
            "checkpointer",
