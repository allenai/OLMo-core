...
**FAST-COMPRESSIVE-LANDMARK** CPT model (block-32 variant) on a 25/75 BLEND of
...
parallelism) is identical for a fair block-size comparison.
  ...
  1. Model: ``fast_compressive_landmark=True, mem_freq=31`` (block 32), with
     ...
     (``qwen3-4b-compressive-landmark-block32/step2385/model_and_optim``). The landmark-token (151860)
...
comparability across variants and block sizes.
    ...
    PYTHONPATH=src python src/scripts/train/sft/amanda-landmark/Qwen3-4B-compressive-block32-5task-dolci25-32k-nocpt-SFT.py \\
        dry_run q4b-comp-block32-5task-dolci25-32k-nocpt ai2/jupiter
    PYTHONPATH=src python src/scripts/train/sft/amanda-landmark/Qwen3-4B-compressive-block32-5task-dolci25-32k-nocpt-SFT.py \\
        launch  q4b-comp-block32-5task-dolci25-32k-nocpt ai2/neptune --launch.num_nodes=2
"""
