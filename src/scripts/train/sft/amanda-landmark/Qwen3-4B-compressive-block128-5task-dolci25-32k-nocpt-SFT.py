...
**FAST-COMPRESSIVE-LANDMARK** CPT model (block-128 variant) on a 25/75 BLEND of
...
parallelism) is identical for a fair block-size comparison.
  ...
  1. Model: ``fast_compressive_landmark=True, mem_freq=127`` (block 128), with
     ...
     (``qwen3-4b-compressive-landmark-block128/step2385/model_and_optim``). The landmark-token (151860)
...
comparability across variants and block sizes.
    ...
    PYTHONPATH=src python src/scripts/train/sft/amanda-landmark/Qwen3-4B-compressive-block128-5task-dolci25-32k-nocpt-SFT.py \\
        dry_run q4b-comp-block128-5task-dolci25-32k-nocpt ai2/jupiter
    PYTHONPATH=src python src/scripts/train/sft/amanda-landmark/Qwen3-4B-compressive-block128-5task-dolci25-32k-nocpt-SFT.py \\
        launch  q4b-comp-block128-5task-dolci25-32k-nocpt ai2/neptune --launch.num_nodes=2
"""
