"""
This script can be used to launch an SFT run for the Qwen3-0.6B model on Beaker.
...
class SFTConfig(Config):
    ...
    def build(
        ...
        *,
        ...
        tokenizer_config = TokenizerConfig.from_hf("Qwen/Qwen3-0.6B-Base")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="SFT the Qwen3-0.6B model.",
