"""
SFT script for the GemmaLike 1.3B ladder model.

Based on Olmo-3-7B-SFT.py, adapted for the GemmaLike v2 1.3B architecture
...
class SFTConfig(Config):
    ...
    def build(
        ...
        *,
        ...
        model = GemmaLikeTransformerConfig.v2_1p3B(
