...
script pattern (build_experiment_config + main, commands launch/train/dry_run)::
    ...
    PYTHONPATH=src python src/scripts/train/sft/Qwen3-4B-dense-cptmix-5task-32k-SFT.py \\
        dry_run q4b-cptmix-5task-32k ai2/jupiter-cirrascale-2
    PYTHONPATH=src python src/scripts/train/sft/Qwen3-4B-dense-cptmix-5task-32k-SFT.py \\
        launch q4b-cptmix-5task-32k ai2/jupiter-cirrascale-2
"""
...
DATA_ROOT = "/weka/oe-training-default/ai2-llm/checkpoints/prasanns/cptmix_data_ladder40k_v3"
...
TARGET_STEPS = 4500  # v3: ~3x the 1465 budget to better cover the expanded long-rung ladder.
...
if __name__ == "__main__":
    ...
    CPT model at 32k context with Ulysses CP degree 8, multi-node.
        ...
        python src/scripts/train/sft/Qwen3-4B-dense-cptmix-5task-32k-SFT.py \\
            dry_run  q4b-cptmix-5task-32k ai2/jupiter-cirrascale-2
        python src/scripts/train/sft/Qwen3-4B-dense-cptmix-5task-32k-SFT.py \\
            launch   q4b-cptmix-5task-32k ai2/jupiter-cirrascale-2
    """
