...
from olmo_core.optim.scheduler import WSDS
from olmo_core.train import Duration, TrainerConfig

# NEW callbacks
from olmo_core.train.callbacks.list_checkpointer import ListCheckpointerCallback
...
EVAL_INTERVAL_STEPS = max(
    1, PERIOD_STEPS[0] // 2
)  # e.g., twice per first period (tune as you like)
PREEMPTIBLE = True
