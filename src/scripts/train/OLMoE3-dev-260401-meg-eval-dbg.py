...
SHARED_MLP_HIDDEN_SIZE = (
    1280  # Hidden size for shared MLP (or dense branch MLP in arctic) in MoE blocks
)
    ...
    config = MoEFusedV2TransformerConfig(
        ...
        block=MoEFusedV2TransformerBlockConfig(
            ...
            routed_experts_router=MoERouterConfigV2(
                ...
                restore_weight_scale=False,  # NOTE: megatron does not support this
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            ...
            checkpoints_to_eval=[
                "/workspace/checkpoint/meg_24L_48N1S4K_2560H-11520F-1280S_24H_8192L-dev-cap1.25-pin/olmo_cvt/iter_0092000",
                # "/workspace/checkpoint/OLMoE3-dev-260401_2560d3072a_24L2560M1280S_48E4K1S_p1-pin/step84000",
            ],
        )
        .with_callback(
            "checkpointer",
...
def finalize_config(config: ExperimentConfig):
    ...
    # modifactions for megatron ckpt naming
    ...
    wandb_cb.group = wandb_original_name
