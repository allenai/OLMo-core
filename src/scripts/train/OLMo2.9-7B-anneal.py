...
[b]Examples[/]
$ [i]python {sys.argv[0]} {SubCmd.launch} gs://ai2-llm/checkpoints/OLMo29/step169210/ 100e9 ai2/augusta-google-1 --launch.num_nodes=2[/]
    """.strip()
    ...
    o29_spec = importlib.util.spec_from_file_location("OLMo2.9-7B", Path(__file__).parent / "OLMo2.9-7B.py")
    ...
    def build_train_module_config(common: CommonComponents) -> TransformerTrainModuleConfig:
        config = o29_module.build_train_module_config(common)
    ...
    def build_trainer_config(common: CommonComponents) -> TrainerConfig:
        config = o29_module.build_trainer_config(common)
    ...
    config = build_config(
        ...
        model_config_builder=o29_module.build_model_config,
