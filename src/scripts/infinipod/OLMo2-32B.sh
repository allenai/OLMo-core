...
SAVE_FOLDER=gs://infinipod-checkpoints/shanea/checkpoints/peteish32/$BASE_RUN_NAME
mkdir -p $SAVE_FOLDER
...
torchrun \
  ...
  src/scripts/train/OLMo2-32B.py $COMMAND $RUN_NAME $CLUSTER --trainer.save_folder=$SAVE_FOLDER ${@}
