...
. ./src/scripts/prime-intellect/utils.sh

REPO_DIR=/data/$USERNAME/RI-OLMo-core
VENV_DIR=/data/$USERNAME/uv/OLMo-core
...
export OLMO_CORE_WORK_DIR=/data/dataset-cache
...
node_0_only log_info "CPUs per node: $SLURM_JOB_CPUS_PER_NODE"
node_0_only log_info "GPUs per node: $SLURM_GPUS_PER_NODE"
node_0_only log_info "CPUs per GPU: $SLURM_CPUS_PER_GPU"
