...
export CORDONED_NODES_FILE=/data/cordoned-nodes.txt
...
path_prepend /data/bin/ /data/slurm/bin/
...
function launch_job {
    ...
    SBATCH_ARGS=(
        --export="USERNAME,WANDB_API_KEY,GOOGLE_APPLICATION_CREDENTIALS,HOME"
        --job-name="$RUN_NAME"
