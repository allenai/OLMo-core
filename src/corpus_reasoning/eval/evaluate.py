...
from corpus_reasoning.lib.io import load_jsonl, save_results, format_alpaca_prompt, insert_dummy_tokens
...
from corpus_reasoning.lib.eval_tasks import (
...
def load_hf_model(args):
    ...
    if args.lora_path:
        ...
        from safetensors import safe_open
        from corpus_reasoning.lib.adapter_save import prepare_adapter_for_backend
    ...
    if use_custom_flex:
        from corpus_reasoning.lib.chunked_attention import install_flex_chunked_attention
        flex_state = {}
...
def main():
    ...
    parser.add_argument(
        ...
        help="Batched eval for chunked-* backends (serial prefill + batched "
             "decode, scripts.eval.batched_chunked_serial_prefill). Verified "
    ...
    if is_hf:
        ...
        _import_vllm()
        from corpus_reasoning.lib.vllm_utils import load_model as vllm_load_model, run_inference
