...
# pyserini (Lucene) is only needed to MINE distractors from the live index. Loading a
# precomputed ArticlePool pickle needs none of it, so defer the import into the searcher
# ctor -- lets envs without pyserini (e.g. the training env) still use cached pools.
