...
def validate_conversion(hf_model):
    ...
    print("converted hf logitis", hf_logits[:100])
    print("type of converted hf logitis", hf_logits.dtype)
    print("original hf logits", logits[:100])
    print("type of original hf logits", logits.dtype)
