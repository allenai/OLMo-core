...
class TransformerConfig(Config):
    ...
    @classmethod
    def olmo2_7B_preorder_no_qk(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        A 7B OLMo model config.
        """
    ...
    @classmethod
    def olmo2_7B_noqk(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        A 7B OLMo model config.
        """
        kwargs.pop("qk_norm", False)  # ignore qk_norm arg 
    ...
    @classmethod
    def llama3_8B_no_gqa(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
    ...
    @classmethod
    def llama3_8B_gqa_4(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
        kwargs.pop('n_kv_heads', None)  # ignore n_kv_heads arg
        return cls.llama_like(
            ...
            n_layers=kwargs.pop("n_layers", 32),
            n_heads=kwargs.pop("n_heads", 32),
            n_kv_heads=4, #kwargs.pop("n_kv_heads", 32),
            rope_theta=kwargs.pop("rope_theta", 500_000),
    ...
    @classmethod
    def llama3_8B_gqa_16(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
        kwargs.pop('n_kv_heads', None)  # ignore n_kv_heads arg
        return cls.llama_like(
            ...
            n_layers=kwargs.pop("n_layers", 32),
            n_heads=kwargs.pop("n_heads", 32),
            n_kv_heads=16, #kwargs.pop("n_kv_heads", 32),
            rope_theta=kwargs.pop("rope_theta", 500_000),
    ...
    @classmethod
    def llama3_8B_qknorm_reordered(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
        return cls.llama_like(
    ...
    @classmethod
    def llama3_8B_qknorm(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
        return cls.llama_like(
    ...
    @classmethod
    def llama3_8B_reordered(cls, vocab_size: int, **kwargs) -> "TransformerConfig":
        """
        An 8B Llama3-like model config.
        """
        return cls.llama_like(
