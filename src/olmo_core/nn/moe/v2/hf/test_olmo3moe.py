...
if __name__ == "__main__":
    ...
    load_path_base = '/workspace/checkpoint/OLMoE3-dev-260319_2560d3072a_24L2560M1280S_48E4K1S_c1/step44500-hf'
    # load_path_k6 = '/workspace/checkpoint/OLMoE3-abl-260102-010d4_1024d1024a_12L768M768S_32E4K1S_abl/step33000-hf-k6'
    base_model = AutoModelForCausalLM.from_pretrained(load_path_base, trust_remote_code=True).to(device).to(torch.bfloat16)
