...
def async_copy_to_cpu(
    ...
    # The caller must keep gpu_buf alive until the copy completes. record_stream() cannot
    # enforce that lifetime here because it is unsupported under torch.compile.
    if return_event:
