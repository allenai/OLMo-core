...
class MoEBase(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        :param seg_id: Optional per-token document ids used by document-aware routers (e.g.
            :class:`~olmo_core.nn.moe.emo_router.EmoRouter`). Only passed to the router when
            provided, so non-document-aware routers are unaffected.
