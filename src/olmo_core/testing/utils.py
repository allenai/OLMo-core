...
# Build the NVSHMEM CUDA extension before test collection to enable rowwise EP tests.
...
# The pipeline NCCL-RMA transport requires multiple GPUs and RMA-capable NCCL with development
# headers for the JIT-compiled extension.
NCCL_RMA_MARKS = (
    pytest.mark.gpu,
    pytest.mark.skipif(not has_multiple_gpus, reason="Requires multiple GPUs"),
    pytest.mark.skipif(
