...
def _build_extension_cmake(*, inplace: bool, verbose: bool, force: bool) -> None:
    ...
    build_dir = repo_root / "build" / "tma_ibgda_ep_cmake"
    ...
    so_name = f"_tma_ibgda_ep_ext_gpu{ext_suffix}"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build OLMo rowwise TMA/IBGDA EP CUDA extension."
    )
    ...
    inplace = args.inplace or _env_bool("OLMO_TMA_IBGDA_EP_BUILD_INPLACE", default=True)
    verbose = args.verbose or _env_bool("OLMO_TMA_IBGDA_EP_BUILD_VERBOSE", default=False)
    force = args.force or _env_bool("OLMO_TMA_IBGDA_EP_BUILD_FORCE", default=False)
