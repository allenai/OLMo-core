...
def debug_nan_inf_grad_norm(
    ...
    *,
    ...
    """Report local parameter and component norms when the total gradient norm is nonfinite.

    Diagnostic callbacks run only for nonfinite norms on selected ranks. Optional saved reports
    retain all entries even when console output is limited.
    ...
    :param max_log_entries: Maximum entries in each console list: nonfinite and top local norms.
