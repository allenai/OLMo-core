...
def adamw_step(
    ...
    *,
    ...
    p.add_(update)
    # step.add_(step_factor) # @davidh disable stepfix to match hero run https://github.com/allenai/OLMo-core/blob/shanea/google-cloud/src/olmo_core/optim/adamw.py
...
def foreach_adamw_step(
    ...
    *,
    ...
    # torch._foreach_add_(steps, [step_factor] * len(steps)) # @davidh disable stepfix to match hero run https://github.com/allenai/OLMo-core/blob/shanea/google-cloud/src/olmo_core/optim/adamw.py
