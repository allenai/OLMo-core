"""Canonical source construction and serialized-example identities for vision alignment.

Keeping source configuration next to the runtime builders gives every phase one implementation
of the model-consumed serialization contract.
"""
