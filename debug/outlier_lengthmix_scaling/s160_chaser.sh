...
JOBS="
lmx-full-mixs96M-4b|full|3k,8k,16k,32k
lmx-slm-mixs96M-4b|slm|3k,8k,16k,32k
lmx-full-mixs160M-4b|full|3k,8k,16k,32k
lmx-slm-mixs160M-4b|slm|3k,8k,16k,32k
lmx-slm-mixs64M-s2-4b|slm|3k,8k,16k,32k
"
...
for i in $(seq 1 200); do
  ...
  N=$(grep -l '^EVAL$' "$STATE"/*.s160.state 2>/dev/null | wc -l)
  echo "[anchor tick $i] $N/5 chained $(date '+%T')"
  [ "$N" -ge 5 ] && break
  sleep 300
done
echo "[anchor] exiting"
