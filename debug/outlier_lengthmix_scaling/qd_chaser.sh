...
JOBS="
lmx-full-q2k5000-qd-4b|full
lmx-slm-q2k5000-qd-4b|slm
lmx-full-q8k4000-qd-4b|full
lmx-slm-q8k4000-qd-4b|slm
"
...
for i in $(seq 1 100); do
  ...
  N=$(grep -l '^EVAL$' "$STATE"/lmx-*-qd-4b.state 2>/dev/null | wc -l)
  echo "[qdchaser tick $i] $N/4 chained $(date '+%T')"
  [ "$N" -ge 4 ] && break
  sleep 300
done
