...
- Fixed bug in GPUMonitorCallback where it was using a Wandb reserved keyword (`system/`), causing data to be unable to be visualized in the Wandb dashboard. Also updated ConsoleLogger to use new `gpu_memory/` prefix instead of `system/`.
