...
As of writing this, the `TransformerTrainModule` supports 3 dimensions of parallelism: data parallelism through FSDP or DDP, tensor parallelism (TP), and context parallelism (CP).
