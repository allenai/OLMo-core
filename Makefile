...
FLASH_ATTN_SHA = "7321879fde54f09ed94f7f6ce9377e2f4cf1fac0"
...
docker-image :
	docker build -f src/Dockerfile \
		...
		--build-arg FLASH_ATTN_SHA=$(FLASH_ATTN_SHA) \
	...
	docker run --rm olmo-core:$(IMAGE_TAG) python -c 'import torch; import transformer_engine.pytorch; import flash_attn; print("Image validated")'
