...
NVIDIA_NCCL_CU13_VERSION = 2.30.7
NVIDIA_NVSHMEM_CU13_VERSION = 3.7.0
INSTALL_CHANNEL = whl
...
docker-image :
	docker build -f src/Dockerfile \
		...
		--build-arg NVIDIA_NCCL_CU13_VERSION="$(NVIDIA_NCCL_CU13_VERSION)" \
		--build-arg NVIDIA_NVSHMEM_CU13_VERSION="$(NVIDIA_NVSHMEM_CU13_VERSION)" \
